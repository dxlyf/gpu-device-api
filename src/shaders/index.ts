...
export {
  ...
  stripWgslComments,
  wgslBindingKeys,
  type WgslAddressSpace,
  type WgslBinding,
  type WgslEntryPoint,
  type WgslEntryPointStage,
  type WgslResourceKind,
} from './reflection/WGSLReflector.js';
export {
  GLSL_SAMPLER_TYPES,
  GLSL_TYPE_NAMES,
  glslTypeName,
  inferBindGroupLayoutEntries,
  isSamplerType,
  reflectGlslProgram,
  reflectSamplerUniforms,
  type GlslActiveAttribute,
  type GlslActiveUniform,
  type GlslActiveUniformBlock,
  type GlslProgramReflection,
} from './reflection/GLSLReflector.js';
