...
export const DEFAULT_WEBGL2_CONTEXT_ATTRIBUTES: WebGLContextAttributes = {
  antialias: true,
  alpha: false,
  depth: true,
  stencil: false,
...
export class WebGL2Adapter implements Adapter {
  ...
  private device: WebGL2Device | null = null;
   ...
   */
  static async request(options: WebGL2AdapterOptions): Promise<WebGL2Adapter> {
  ...
  async requestDevice(descriptor: DeviceDescriptor = {}): Promise<Device> {
