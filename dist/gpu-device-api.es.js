...
function Sw(t, e, r = ue.D2) {
  if (!Number.isInteger(e) || e < 0)
    throw new u(
      `[gpu-device-api] mipLevelExtent: level must be a non-negative integer, got ${String(e)}.`
    );
  if (r !== ue.D1 && r !== ue.D2 && r !== ue.D3)
    throw new u(
      `[gpu-device-api] mipLevelExtent: dimension must be "1d", "2d" or "3d", got ${String(r)}.`
    );
  const n = or(t), i = (s) => Math.max(1, Math.trunc(s / 2 ** e));
  return {
    width: i(n.width),
    height: i(n.height),
    // 只有 3d 的 depth 减半；2d / 2d-array 的层数在每一级都保持不变。
    depthOrArrayLayers: r === ue.D3 ? i(n.depthOrArrayLayers) : n.depthOrArrayLayers
  };
}
function Qo(t = 0) {
...
function Ts(t, e) {
  if (t.querySet.type !== et.Timestamp)
    throw new u(
...
function Zo(t, e, r) {
  ...
  return Se({ label: t, backend: e, messages: n, rawLogs: i });
}
function Ko(t, e) {
  return Se({ label: t, backend: e });
}
function Te(t) {
  return {
    type: t.type,
...
function nt(t = "gpu-device-api", e) {
...
function Tc(t) {
  const e = t[0], r = t[1], n = t[2], i = t[3], s = t[4], a = t[5], o = t[6], l = t[7], c = t[8], h = c * s - a * l, p = -c * i + a * o, d = l * i - s * o;
  return e * h + r * p + n * d;
}
function qs(t, e) {
  const r = e[0], n = e[1], i = e[2], s = e[3], a = e[4], o = e[5], l = e[6], c = e[7], h = e[8], p = h * a - o * c, d = -h * s + o * l, f = c * s - a * l;
  let b = r * p + n * d + i * f;
  return b ? (b = 1 / b, t[0] = p * b, t[1] = (-h * n + i * c) * b, t[2] = (o * n - i * a) * b, t[3] = d * b, t[4] = (h * r - i * l) * b, t[5] = (-o * r + i * s) * b, t[6] = f * b, t[7] = (-c * r + n * l) * b, t[8] = (a * r - n * s) * b, t) : null;
}
function $c(t, e, r) {
  const n = e[0], i = e[1], s = e[2], a = e[3], o = e[4], l = e[5], c = e[6], h = e[7], p = e[8], d = r[0], f = r[1], b = r[2], m = r[3], g = r[4], w = r[5], y = r[6], v = r[7], T = r[8];
  return t[0] = d * n + f * a + b * c, t[1] = d * i + f * o + b * h, t[2] = d * s + f * l + b * p, t[3] = m * n + g * a + w * c, t[4] = m * i + g * o + w * h, t[5] = m * s + g * l + w * p, t[6] = y * n + v * a + T * c, t[7] = y * i + v * o + T * h, t[8] = y * s + v * l + T * p, t;
}
function Ec(t, e, r) {
  const n = e[0], i = e[1], s = e[2], a = e[3], o = e[4], l = e[5], c = e[6], h = e[7], p = e[8], d = r[0], f = r[1], b = r[2];
  return t[0] = d * n, t[1] = d * i, t[2] = d * s, t[3] = f * a, t[4] = f * o, t[5] = f * l, t[6] = b * c, t[7] = b * h, t[8] = b * p, t;
}
function Ac(t, e, r) {
  const n = e[0], i = e[1], s = e[2], a = e[3], o = e[4], l = e[5], c = e[6], h = e[7], p = e[8], d = r[0], f = r[1];
  return t[0] = n, t[1] = i, t[2] = s, t[3] = a, t[4] = o, t[5] = l, t[6] = d * n + f * a + c, t[7] = d * i + f * o + h, t[8] = d * s + f * l + p, t;
}
function Pc(t, e, r) {
  const n = e[0], i = e[1], s = e[2], a = e[3], o = e[4], l = e[5], c = e[6], h = e[7], p = e[8], d = Math.sin(r), f = Math.cos(r);
  return t[0] = f * n + d * a, t[1] = f * i + d * o, t[2] = f * s + d * l, t[3] = f * a - d * n, t[4] = f * o - d * i, t[5] = f * l - d * s, t[6] = c, t[7] = h, t[8] = p, t;
}
function mn(t, e) {
...
function Bc(t, e) {
  const r = e[0], n = e[1], i = e[2], s = e[3], a = e[4], o = e[5], l = e[6], c = e[7], h = e[8], p = e[9], d = e[10], f = e[11], b = e[12], m = e[13], g = e[14], w = e[15];
  return t[0] = r, t[1] = a, t[2] = h, t[3] = b, t[4] = n, t[5] = o, t[6] = p, t[7] = m, t[8] = i, t[9] = l, t[10] = d, t[11] = g, t[12] = s, t[13] = c, t[14] = f, t[15] = w, t;
}
function Ys(t) {
  const e = t[0], r = t[1], n = t[2], i = t[3], s = t[4], a = t[5], o = t[6], l = t[7], c = t[8], h = t[9], p = t[10], d = t[11], f = t[12], b = t[13], m = t[14], g = t[15], w = e * a - r * s, y = e * o - n * s, v = e * l - i * s, T = r * o - n * a, E = r * l - i * a, P = n * l - i * o, L = c * b - h * f, B = c * m - p * f, G = c * g - d * f, z = h * m - p * b, q = h * g - d * b, X = p * g - d * m;
  return w * X - y * q + v * z + T * G - E * B + P * L;
}
function hr(t, e) {
  const r = e[0], n = e[1], i = e[2], s = e[3], a = e[4], o = e[5], l = e[6], c = e[7], h = e[8], p = e[9], d = e[10], f = e[11], b = e[12], m = e[13], g = e[14], w = e[15], y = r * o - n * a, v = r * l - i * a, T = r * c - s * a, E = n * l - i * o, P = n * c - s * o, L = i * c - s * l, B = h * m - p * b, G = h * g - d * b, z = h * w - f * b, q = p * g - d * m, X = p * w - f * m, ne = d * w - f * g;
  let _ = y * ne - v * X + T * q + E * z - P * G + L * B;
  return _ ? (_ = 1 / _, t[0] = (o * ne - l * X + c * q) * _, t[1] = (i * X - n * ne - s * q) * _, t[2] = (m * L - g * P + w * E) * _, t[3] = (d * P - p * L - f * E) * _, t[4] = (l * z - a * ne - c * G) * _, t[5] = (r * ne - i * z + s * G) * _, t[6] = (g * T - b * L - w * v) * _, t[7] = (h * L - d * T + f * v) * _, t[8] = (a * X - o * z + c * B) * _, t[9] = (n * z - r * X - s * B) * _, t[10] = (b * P - m * T + w * y) * _, t[11] = (p * T - h * P - f * y) * _, t[12] = (o * G - a * q - l * B) * _, t[13] = (r * q - n * G + i * B) * _, t[14] = (m * v - b * E - g * y) * _, t[15] = (h * E - p * v + d * y) * _, t) : null;
}
function K(t, e, r) {
  const n = e[0], i = e[1], s = e[2], a = e[3], o = e[4], l = e[5], c = e[6], h = e[7], p = e[8], d = e[9], f = e[10], b = e[11], m = e[12], g = e[13], w = e[14], y = e[15], v = r[0], T = r[1], E = r[2], P = r[3], L = r[4], B = r[5], G = r[6], z = r[7], q = r[8], X = r[9], ne = r[10], _ = r[11], $t = r[12], Et = r[13], At = r[14], Pt = r[15];
  return t[0] = v * n + T * o + E * p + P * m, t[1] = v * i + T * l + E * d + P * g, t[2] = v * s + T * c + E * f + P * w, t[3] = v * a + T * h + E * b + P * y, t[4] = L * n + B * o + G * p + z * m, t[5] = L * i + B * l + G * d + z * g, t[6] = L * s + B * c + G * f + z * w, t[7] = L * a + B * h + G * b + z * y, t[8] = q * n + X * o + ne * p + _ * m, t[9] = q * i + X * l + ne * d + _ * g, t[10] = q * s + X * c + ne * f + _ * w, t[11] = q * a + X * h + ne * b + _ * y, t[12] = $t * n + Et * o + At * p + Pt * m, t[13] = $t * i + Et * l + At * d + Pt * g, t[14] = $t * s + Et * c + At * f + Pt * w, t[15] = $t * a + Et * h + At * b + Pt * y, t;
}
function Gc(t, ...e) {
...
function Hs(t, e, r) {
  ...
  if (a < Zt) return Y(t);
  a = 1 / a, n *= a, i *= a, s *= a;
  const o = Math.sin(e), l = Math.cos(e), c = 1 - l, h = n * n * c + l, p = i * n * c + s * o, d = s * n * c - i * o, f = n * i * c - s * o, b = i * i * c + l, m = s * i * c + n * o, g = n * s * c + i * o, w = i * s * c - n * o, y = s * s * c + l;
  return t[0] = h, t[1] = p, t[2] = d, t[3] = 0, t[4] = f, t[5] = b, t[6] = m, t[7] = 0, t[8] = g, t[9] = w, t[10] = y, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1, t;
}
function gn(t, e) {
...
function yn(t, e, r, n, i) {
  ...
  l = 1 / l, s *= l, a *= l, o *= l;
  const c = Math.sin(e), h = Math.cos(e), p = 1 - h, d = s * s * p + h, f = a * s * p + o * c, b = o * s * p - a * c, m = s * a * p - o * c, g = a * a * p + h, w = o * a * p + s * c, y = s * o * p + a * c, v = a * o * p - s * c, T = o * o * p + h, E = i[0], P = i[1], L = i[2];
  return t[0] = d * E, t[1] = f * E, t[2] = b * E, t[3] = 0, t[4] = m * P, t[5] = g * P, t[6] = w * P, t[7] = 0, t[8] = y * L, t[9] = v * L, t[10] = T * L, t[11] = 0, t[12] = n[0], t[13] = n[1], t[14] = n[2], t[15] = 1, t;
}
...
function Jc(t, e, r, n) {
  return St(new Float32Array(4), t, e, r, n);
}
function pr(t) {
...
function nu(t, e, r) {
  ...
  return Be(t, e, St($n, i, 0, 0, s));
}
function iu(t, e, r) {
  const n = r * 0.5, i = Math.sin(n), s = Math.cos(n);
  return Be(t, e, St($n, 0, i, 0, s));
}
function su(t, e, r) {
  const n = r * 0.5, i = Math.sin(n), s = Math.cos(n);
  return Be(t, e, St($n, 0, 0, i, s));
}
const $n = ta();
function jt(t, e, r) {
...
function ou(t, e, r) {
  const n = e[0], i = e[1], s = e[2], a = r[0], o = r[1], l = r[2];
  let c = n * a + i * o + s * l + 1;
  return c < 1e-8 ? (c = 0, Math.abs(n) > Math.abs(s) ? (t[0] = -i, t[1] = n, t[2] = 0) : (t[0] = 0, t[1] = -s, t[2] = i), t[3] = c) : (t[0] = i * l - s * o, t[1] = s * a - n * l, t[2] = n * o - i * a, t[3] = c), rt(t, t);
}
function lu(t, e, r) {
  const n = r[0], i = r[1], s = r[2], a = e[0], o = e[1], l = e[2], c = e[3], h = 2 * (o * s - l * i), p = 2 * (l * n - a * s), d = 2 * (a * i - o * n);
  return t[0] = n + c * h + (o * d - l * p), t[1] = i + c * p + (l * h - a * d), t[2] = s + c * d + (a * p - o * h), t;
}
function cu(t, e, r, n) {
  let i = r[0], s = r[1], a = r[2], o = r[3], l = Sn(e, r);
  if (l < 0 && (l = -l, i = -i, s = -s, a = -a, o = -o), l > 0.9995)
    return t[0] = e[0] + (i - e[0]) * n, t[1] = e[1] + (s - e[1]) * n, t[2] = e[2] + (a - e[2]) * n, t[3] = e[3] + (o - e[3]) * n, rt(t, t);
  const c = Math.acos(l), h = Math.sin(c), p = Math.sin((1 - n) * c) / h, d = Math.sin(n * c) / h;
  return t[0] = e[0] * p + i * d, t[1] = e[1] * p + s * d, t[2] = e[2] * p + a * d, t[3] = e[3] * p + o * d, rt(t, t);
}
function uu(t, e, r, n) {
  return t[0] = e[0] + (r[0] - e[0]) * n, t[1] = e[1] + (r[1] - e[1]) * n, t[2] = e[2] + (r[2] - e[2]) * n, t[3] = e[3] + (r[3] - e[3]) * n, rt(t, t);
}
function ia(t, e) {
  const r = e[0], n = e[1], i = e[2], s = e[3], a = r + r, o = n + n, l = i + i, c = r * a, h = r * o, p = r * l, d = n * o, f = n * l, b = i * l, m = s * a, g = s * o, w = s * l;
  return t[0] = 1 - (d + b), t[1] = h + w, t[2] = p - g, t[3] = 0, t[4] = h - w, t[5] = 1 - (c + b), t[6] = f + m, t[7] = 0, t[8] = p + g, t[9] = f - m, t[10] = 1 - (c + d), t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1, t;
}
...
function $u(t, e) {
  const r = aa[e.order], n = Sr(r[0], He(e, r[0]), wu), i = Sr(r[1], He(e, r[1]), yu), s = Sr(r[2], He(e, r[2]), vu);
  return K(Hr, n, i), K(t, Hr, s);
}
function Eu(t, e) {
  const r = aa[e.order], n = jt(xu, xr[r[0]], He(e, r[0])), i = jt(Su, xr[r[1]], He(e, r[1])), s = jt(Tu, xr[r[2]], He(e, r[2]));
  return Be(qn, n, i), Be(t, qn, s);
}
function oa(t, e) {
  const r = e[0], n = e[1], i = e[2], s = e[4], a = e[5], o = e[6], l = e[8], c = e[9], h = e[10], p = (f) => f < -1 ? -1 : f > 1 ? 1 : f, d = 0.9999999;
  switch (t.order) {
    case "XYZ":
      t.y = Math.asin(p(l)), Math.abs(l) < d ? (t.x = Math.atan2(-c, h), t.z = Math.atan2(-s, r)) : (t.x = Math.atan2(o, a), t.z = 0);
      break;
    case "YXZ":
      t.x = Math.asin(-p(c)), Math.abs(c) < d ? (t.y = Math.atan2(l, h), t.z = Math.atan2(n, a)) : (t.y = Math.atan2(-i, r), t.z = 0);
      break;
    case "ZXY":
      t.x = Math.asin(p(o)), Math.abs(o) < d ? (t.y = Math.atan2(-i, h), t.z = Math.atan2(-s, a)) : (t.y = 0, t.z = Math.atan2(n, r));
      break;
    case "ZYX":
      t.y = Math.asin(-p(i)), Math.abs(i) < d ? (t.x = Math.atan2(o, h), t.z = Math.atan2(n, r)) : (t.x = 0, t.z = Math.atan2(-s, a));
      break;
    case "YZX":
      t.z = Math.asin(p(n)), Math.abs(n) < d ? (t.x = Math.atan2(-c, a), t.y = Math.atan2(-i, r)) : (t.x = 0, t.y = Math.atan2(l, h));
      break;
    case "XZY":
      t.z = Math.asin(-p(s)), Math.abs(s) < d ? (t.x = Math.atan2(o, a), t.y = Math.atan2(l, r)) : (t.x = Math.atan2(-c, h), t.y = 0);
      break;
  }
  return t;
}
...
const ny = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  toMat4: $u,
  toQuaternion: Eu
}, Symbol.toStringTag, { value: "Module" })), dr = 1e-12, Lt = new Float32Array(3), Pu = new Float32Array(9);
function Ce(t = 0, e = 0, r = 1, n = 0) {
...
function Cu(t, e, r) {
  ...
  return t.normal[0] = e[0] * i, t.normal[1] = e[1] * i, t.normal[2] = e[2] * i, t.constant = -ge(t.normal, r), t;
}
function Mu(t, e, r, n) {
  ...
  return a < dr ? null : (t.normal[0] = t.normal[0] / a, t.normal[1] = t.normal[1] / a, t.normal[2] = t.normal[2] / a, t.constant = -ge(t.normal, e), t);
}
function ca(t, e) {
...
function fe(t, e) {
  return ge(t.normal, e) + t.constant;
}
function Fu(t, e, r) {
  const n = fe(e, r);
...
function Bu(t, e, r) {
  return En(t, e), t.constant -= ge(r, e.normal), t;
}
function Gu(t, e, r) {
  const n = fe(t, e), i = fe(t, r);
...
function Ou(t, e, r) {
  ...
  ua(Lt, e), fn(Lt, Lt, r), Ds(t.normal, e.normal, n);
  ...
  return t.normal[0] = t.normal[0] / i, t.normal[1] = t.normal[1] / i, t.normal[2] = t.normal[2] / i, t.constant = -ge(t.normal, Lt), t;
}
...
function Iu() {
  return Ge({ min: new Float32Array(3), max: new Float32Array(3) });
}
function Ge(t) {
...
function zu(t, e) {
  return W(e) ? (t[0] = 0, t[1] = 0, t[2] = 0, t) : de(t, e.max, e.min);
}
function qu(t, e) {
...
function ju(t, e) {
  return bt(t.min, t.min, e), bt(t.max, t.max, e), t;
}
function Qu(t, e) {
...
function Ju(t, e, r) {
  return Kt(t, e), bt(t.min, t.min, r), bt(t.max, t.max, r), t;
}
function eh(t, e, r) {
  return W(e) ? Kt(t, r) : W(r) ? Kt(t, e) : (cr(t.min, e.min, r.min), ur(t.max, e.max, r.max), t);
}
function th(t, e, r) {
  return da(e, r) ? (ur(t.min, e.min, r.min), cr(t.max, e.max, r.max), t) : Ge(t);
}
function rh(t, e, r) {
  if (W(e)) return Ge(t);
  ...
  Ge(t);
  for (let c = 0; c < 8; c++) {
    const h = c & 1 ? a : n, p = c & 2 ? o : i, d = c & 4 ? l : s, f = r[3] * h + r[7] * p + r[11] * d + r[15], b = f === 0 ? 1 : 1 / f;
    oe[0] = (r[0] * h + r[4] * p + r[8] * d + r[12]) * b, oe[1] = (r[1] * h + r[5] * p + r[9] * d + r[13]) * b, oe[2] = (r[2] * h + r[6] * p + r[10] * d + r[14]) * b, An(t, oe);
  }
  return t;
}
function nh(t, e, r) {
...
function fa(t, e, r) {
  const n = Math.max(0, ge(de(ga, r, e.origin), e.direction));
  return Ln(t, e, n);
}
function uh(t, e) {
...
function ba(t, e) {
  const r = ge(e.normal, t.direction);
  if (Math.abs(r) < 1e-12) return null;
  const n = -fe(e, t.origin) / r;
  return n >= 0 ? n : null;
}
function wa(t, e, r) {
  const n = t.origin[0] - e[0], i = t.origin[1] - e[1], s = t.origin[2] - e[2], a = t.direction[0], o = t.direction[1], l = t.direction[2], c = n * a + i * o + s * l, h = n * n + i * i + s * s - r * r, p = c * c - h;
  if (p < 0) return null;
...
function ya(t, e) {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    if (h > r && (r = h), p < n && (n = p), r > n) return null;
  }
  return Number.isFinite(n) ? r : null;
}
function va(t, e, r, n, i = !1) {
  const s = r[0] - e[0], a = r[1] - e[1], o = r[2] - e[2], l = n[0] - e[0], c = n[1] - e[1], h = n[2] - e[2], p = t.direction[0], d = t.direction[1], f = t.direction[2], b = d * h - f * c, m = f * l - p * h, g = p * c - d * l, w = s * b + a * m + o * g;
  if (i ? w < 1e-12 : Math.abs(w) < 1e-12) return null;
  const y = 1 / w, v = t.origin[0] - e[0], T = t.origin[1] - e[1], E = t.origin[2] - e[2], P = (v * b + T * m + E * g) * y;
  if (P < 0 || P > 1) return null;
  const L = T * o - E * a, B = E * s - v * o, G = v * a - T * s, z = (p * L + d * B + f * G) * y;
...
function Sa(t, e, r = "gl") {
  const n = [e[0], e[4], e[8], e[12]], i = [e[1], e[5], e[9], e[13]], s = [e[2], e[6], e[10], e[14]], a = [e[3], e[7], e[11], e[15]], o = (c, h, p) => [
    c[0] + p * h[0],
    c[1] + p * h[1],
    c[2] + p * h[2],
    c[3] + p * h[3]
  ...
  for (let c = 0; c < 6; c++) {
    const [h, p, d, f] = l[c];
    la(t.planes[c], h, p, d, f), ca(t.planes[c], t.planes[c]);
  }
  return t;
}
function bh(t, e) {
  for (const r of t.planes)
    if (fe(r, e) < 0) return !1;
  return !0;
}
function Ta(t, e, r) {
  for (const n of t.planes)
    if (fe(n, e) < -r) return !1;
  return !0;
}
function wh(t, e) {
  for (const r of t.planes) {
...
function xh(t, e, r) {
  const n = t.normal[0], i = t.normal[1], s = t.normal[2], a = e.normal[0], o = e.normal[1], l = e.normal[2], c = r.normal[0], h = r.normal[1], p = r.normal[2], d = n * (o * p - l * h) - i * (a * p - l * c) + s * (a * h - o * c);
  if (Math.abs(d) < 1e-12) return null;
  const f = 1 / d, b = -t.constant, m = -e.constant, g = -r.constant;
  return new Float32Array([
    (b * (o * p - l * h) - i * (m * p - l * g) + s * (m * h - o * g)) * f,
    (n * (m * p - l * g) - b * (a * p - l * c) + s * (a * g - m * c)) * f,
    (n * (o * g - m * h) - i * (a * g - m * c) + b * (a * h - o * c)) * f
  ]);
}
...
const ly = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  toArray: Dh,
  toString: qh
}, Symbol.toStringTag, { value: "Module" })), jh = new Float32Array(16), jn = new Float32Array(16), Qh = { origin: new Float32Array(3), direction: new Float32Array(3) }, Re = new Float32Array(3), Jt = new Float32Array(3), Qn = new Float32Array(3), Yn = new Float32Array(3), $a = new Float32Array(3);
...
function Zh(t, e, r) {
  return Cn(t, e, de($a, r, e));
}
function Kh(t, e, r, n, i = "gl") {
  const s = i === "zo" ? 0 : -1, a = 1;
  return er(Re, e, r, s, n), er(Jt, e, r, a, n), Cn(t, Re, de($a, Jt, Re));
}
...
function Ea(t, e, r, n, i = []) {
  ...
  for (let c = 0; c < o; c++) {
    const h = r ? r[c * 3] ?? 0 : c * 3, p = r ? r[c * 3 + 1] ?? 0 : c * 3 + 1, d = r ? r[c * 3 + 2] ?? 0 : c * 3 + 2;
    if (h >= a || p >= a || d >= a) continue;
    Tr(Jt, e, h), Tr(Qn, e, p), Tr(Yn, e, d);
    const f = va(s, Jt, Qn, Yn, l);
    if (f === null) continue;
    Ln(Re, s, f);
    const b = new Float32Array([Re[0], Re[1], Re[2]]);
    n && er(b, b[0], b[1], b[2], n);
    const m = Us(t.ray.origin, b);
    mr(t, m) && i.push({ distance: m, point: b, triangleIndex: c, vertexIndices: [h, p, d] });
  }
...
const cy = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setFromNdc: Kh,
  setFromPoints: Zh
}, Symbol.toStringTag, { value: "Module" })), uy = 1e-6, op = Math.PI / 180, lp = 180 / Math.PI;
function Aa(t) {
  return t * op;
}
function hy(t) {
  ...
  if (i) {
    ...
    if (h) {
      ...
      if (!/^300\s+es\b/.test(p))
        throw new u(
          `[gpu-device-api] ShaderModule「${r}」声明了 \`#version ${p}\`，但 WebGL2 后端只接受 GLSL ES 3.00（\`#version 300 es\`）。请删掉 \`#version\` 行，或改为 \`#version 300 es\`。
...
`;
  ...
  for (const c of [...s].sort((h, p) => h - p)) {
    l.push(`----- 第 ${c} 行附近 -----`);
    const h = Math.max(1, c - 3), p = Math.min(n.length, c + 3);
    l.push(Zr(n.slice(h - 1, p), h));
  }
  return `${i}
${l.join(`
`)}
...
function Ey(t) {
  ...
  for (const { regex: i, swapped: s } of n) {
    ...
    for (; (a = i.exec(e)) !== null; ) {
      ...
      r.some((d) => d.group === o && d.binding === l) || r.push(Tp(o, l, c, h, p));
    }
  }
...
function Gp(t) {
  ...
  return {
    ...
    maxBindGroups: Pe.maxBindGroups,
    maxBindGroupsPlusVertexBuffers: Pe.maxBindGroupsPlusVertexBuffers,
    maxBindingsPerBindGroup: Pe.maxBindingsPerBindGroup,
    maxDynamicUniformBuffersPerPipelineLayout: Math.min(
      Pe.maxDynamicUniformBuffersPerPipelineLayout,
    ...
    minStorageBufferOffsetAlignment: Pe.minStorageBufferOffsetAlignment,
    maxVertexBuffers: Math.min(Pe.maxVertexBuffers, e.maxVertexAttribs),
    maxBufferSize: 2147483647,
    maxVertexAttributes: e.maxVertexAttribs,
    maxVertexBufferArrayStride: 2048,
    maxInterStageShaderVariables: e.maxVaryingVectors,
    maxColorAttachments: 4,
    maxColorAttachmentBytesPerSample: Pe.maxColorAttachmentBytesPerSample,
    maxComputeWorkgroupStorageSize: 0,
    maxComputeInvocationsPerWorkgroup: 0,
    maxComputeWorkgroupSizeX: 0,
    maxComputeWorkgroupSizeY: 0,
...
class kp {
  ...
  setBlendConstant(e) {
    at(this.blendConstant, e) || (this.gl.blendColor(e[0], e[1], e[2], e[3]), this.blendConstant = [e[0], e[1], e[2], e[3]]);
  }
  setColorMask(e) {
  ...
  setViewport(e, r, n, i) {
    at(this.viewport, [e, r, n, i]) || (this.gl.viewport(e, r, n, i), this.viewport = [e, r, n, i]);
  }
  /**
  ...
  setScissor(e, r, n, i, s) {
    const a = this.gl;
    e && (this.scissorWholeBox = [0, 0, i, s]), this.scissorEnabled !== e && (e ? a.enable(a.SCISSOR_TEST) : a.disable(a.SCISSOR_TEST), this.scissorEnabled = e), e && !at(this.scissor, [r, n, i, s]) && (a.scissor(r, n, i, s), this.scissor = [r, n, i, s]);
  }
  /**
  ...
  resetScissor(e, r) {
    ...
    this.scissorEnabled === !1 && at(this.scissor, i) && at(this.scissorWholeBox, i) || (n.disable(n.SCISSOR_TEST), n.scissor(0, 0, e, r), this.scissorEnabled = !1, this.scissor = i, this.scissorWholeBox = i);
  }
...
function zp(t) {
  return t instanceof ar ? "out-of-memory" : t instanceof mt ? "internal" : "validation";
}
function qp(t, e) {
  const r = Wp(t), n = { glError: t, context: e };
  return t === Me.OUT_OF_MEMORY ? new ar(
    `[gpu-device-api] GL out of memory (${r}) observed during ${e}.`,
    { details: n }
  ) : t === Me.INVALID_ENUM || t === Me.INVALID_VALUE || t === Me.INVALID_OPERATION || t === Me.INVALID_FRAMEBUFFER_OPERATION ? new u(
    ...
    { details: n }
  ) : t === Me.CONTEXT_LOST_WEBGL ? new mt(
...
class Xp {
  ...
  _disposed = !1;
  constructor(e, r, n, i) {
    if (tt(n.size, "BufferDescriptor.size"), n.size % 4 !== 0)
      throw new u(
  ...
  async mapAsync(e, r = 0, n = this.size - r) {
    ...
    if ($e(r, "mapAsync 的 offset"), tt(n, "mapAsync 的 size"), r % 4 !== 0)
      throw new u(
...
const Ud = Object.freeze({
  r8unorm: $(ed, _t, Le, 1, { uploadType: "Uint8Array" }),
  r8snorm: $(td, _t, Ne, 1, { attachment: !1, uploadType: "Int8Array" }),
  r8uint: $(rd, De, Le, 1, { sampleType: "uint", uploadType: "Uint8Array" }),
  r8sint: $(nd, De, Ne, 1, { sampleType: "sint", uploadType: "Int8Array" }),
  r16uint: $(id, De, Mt, 2, { sampleType: "uint", uploadType: "Uint16Array" }),
  r16sint: $(sd, De, Er, 2, { sampleType: "sint", uploadType: "Int16Array" }),
  r16float: $(ad, _t, Pr, 2, { uploadType: "Uint16Array" }),
  rg8unorm: $(od, Ct, Le, 2, { uploadType: "Uint8Array" }),
  rg8snorm: $(ld, Ct, Ne, 2, { attachment: !1, uploadType: "Int8Array" }),
  rg8uint: $(cd, ke, Le, 2, { sampleType: "uint", uploadType: "Uint8Array" }),
  rg8sint: $(ud, ke, Ne, 2, { sampleType: "sint", uploadType: "Int8Array" }),
  r32uint: $(hd, De, ot, 4, { sampleType: "uint", uploadType: "Uint32Array" }),
  r32sint: $(pd, De, Ar, 4, { sampleType: "sint", uploadType: "Int32Array" }),
  r32float: $(dd, _t, Rt, 4, { attachment: !1, uploadType: "Float32Array" }),
  rg16uint: $(fd, ke, Mt, 4, { sampleType: "uint", uploadType: "Uint16Array" }),
  rg16sint: $(md, ke, Er, 4, { sampleType: "sint", uploadType: "Int16Array" }),
  rg16float: $(gd, Ct, Pr, 4, { uploadType: "Uint16Array" }),
  rgba8unorm: $(bd, Ie, Le, 4, { uploadType: "Uint8Array" }),
  "rgba8unorm-srgb": $(wd, Ie, Le, 4, { uploadType: "Uint8Array" }),
  rgba8snorm: $(yd, Ie, Ne, 4, { attachment: !1, uploadType: "Int8Array" }),
  rgba8uint: $(vd, Ve, Le, 4, { sampleType: "uint", uploadType: "Uint8Array" }),
  rgba8sint: $(xd, Ve, Ne, 4, { sampleType: "sint", uploadType: "Int8Array" }),
  rgb10a2unorm: $(Sd, Ie, Kp, 4, { uploadType: "Uint32Array" }),
  rg11b10ufloat: $(Td, Hp, ot, 4, { attachment: !1, uploadType: null }),
  rg32uint: $($d, ke, ot, 8, { sampleType: "uint", uploadType: "Uint32Array" }),
  rg32sint: $(Ed, ke, Ar, 8, { sampleType: "sint", uploadType: "Int32Array" }),
  rg32float: $(Ad, Ct, Rt, 8, { attachment: !1, uploadType: "Float32Array" }),
  rgba16uint: $(Pd, Ve, Mt, 8, { sampleType: "uint", uploadType: "Uint16Array" }),
  rgba16sint: $(Ld, Ve, Er, 8, { sampleType: "sint", uploadType: "Int16Array" }),
  rgba16float: $(_d, Ie, Pr, 8, { uploadType: "Uint16Array" }),
  rgba32uint: $(Cd, Ve, ot, 16, { sampleType: "uint", uploadType: "Uint32Array" }),
  rgba32sint: $(Md, Ve, Ar, 16, { sampleType: "sint", uploadType: "Int32Array" }),
  rgba32float: $(Rd, Ie, Rt, 16, { uploadType: "Float32Array" }),
  depth16unorm: $(Fd, $r, Mt, 2, {
    depth: !0,
    sampleType: "depth",
    uploadType: "Uint16Array"
  }),
  depth24plus: $(Bd, $r, ot, 4, {
    depth: !0,
    sampleType: "depth",
...
class Ba {
  ...
  constructor(e, r) {
    const n = Yt(e, r);
    if (n.swizzle !== void 0 && n.swizzle !== gt)
      throw new u(
...
class ti {
  ...
  constructor(e, r, n, i) {
    ...
    const s = or(n.size);
    if (tt(s.width, "TextureDescriptor.size.width"), s.height <= 0 || s.depthOrArrayLayers <= 0)
      throw new u(
        `[gpu-device-api] 纹理尺寸必须为正数，实际是 ${s.width}x${s.height}x${s.depthOrArrayLayers}。`
      );
    const a = F(n.format), o = n.dimension ?? ue.D2, l = n.sampleCount ?? 1, c = n.mipLevelCount ?? 1;
    if (l > 1) {
      if (o !== ue.D2 || s.depthOrArrayLayers > 1)
        throw new u(
...
function gf(t, e) {
  ...
  let s = 0, a = 0;
  t.forEach((d, f) => {
    const b = [...d].sort((g, w) => g.binding - w.binding), m = b.filter((g) => g.type === k.Sampler || g.type === k.ComparisonSampler);
    for (const g of b)
      switch (i.push(`${f}:${g.binding}:${g.type}:${g.name ?? ""}:${g.buffer?.hasDynamicOffset ? "dyn" : ""}`), g.type) {
        case k.Uniform: {
          if (!g.name)
            throw new u(
              `[gpu-device-api] group ${f} 的 binding ${g.binding} 是 uniform buffer，但没有给 \`name\`。WebGL2 后端必须靠名字去 \`gl.getUniformBlockIndex\` 定位 GLSL 里的 uniform block，请在 BindGroupLayoutEntry 上填上着色器里使用的块名。`
            );
          ...
          r.set(ci(f, g.binding), {
            group: f,
            binding: g.binding,
            name: g.name,
            blockBinding: s++,
            dynamic: g.buffer?.hasDynamicOffset ?? !1,
            minBindingSize: g.buffer?.minBindingSize ?? 0
          });
          break;
        }
        case k.Texture: {
          if (!g.name)
            throw new u(
              `[gpu-device-api] group ${f} 的 binding ${g.binding} 是纹理，但没有给 \`name\`。WebGL2 后端靠它给 GLSL 的 sampler uniform 赋纹理单元，请填上着色器里的变量名。`
            );
          ...
          n.set(ci(f, g.binding), {
            ...
            sampleType: g.texture?.sampleType ?? "float"
          });
          break;
        }
        case k.Sampler:
        ...
        case k.ReadOnlyStorage:
          throw new u(
            `[gpu-device-api] group ${f} 的 binding ${g.binding} 是 storage buffer，WebGL2 不支持（shader storage buffer 需要 GLES 3.1）。请改用 uniform buffer。`
          );
        case k.StorageTexture:
          throw new u(
            `[gpu-device-api] group ${f} 的 binding ${g.binding} 是 storage texture，WebGL2 不支持。请改用「渲染到纹理 + 采样」的方式。`
          );
        default: {
          const w = g.type;
  ...
  const o = new Set(
    [...n.values()].map((d) => d.samplerBinding).filter((d) => d !== null)
  );
  for (const [d, f] of t.entries())
    for (const b of f)
      if ((b.type === k.Sampler || b.type === k.ComparisonSampler) && !o.has(b.binding))
        throw new u(
          `[gpu-device-api] group ${d} 的 sampler binding ${b.binding}` + (b.name ? `（「${b.name}」）` : "") + " 找不到配对的纹理条目。请把纹理命名为 `<名字>` 并把 sampler 命名为 `<名字>_sampler`，或把 sampler 的 binding 设为「纹理 binding + 1」。"
        );
  const l = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Set();
  for (const d of r.values())
    We(l, d.group).push(d), d.dynamic && We(c, d.group).push(d), p.add(d.group);
  for (const d of n.values())
    We(h, d.group).push(d), p.add(d.group);
  for (const d of p)
    We(l, d), We(c, d), We(h, d);
  return {
    uniformBlocks: r,
    textures: n,
...
class Rn {
  ...
  acquire(e, r, n) {
    ...
    if (a.attachShader(p, c), a.attachShader(p, h), a.linkProgram(p), a.detachShader(p, c), a.detachShader(p, h), a.deleteShader(c), a.deleteShader(h), lt(a.getProgramInfoLog(p), e, null, o, l), !a.getProgramParameter(p, a.LINK_STATUS)) {
      const m = a.getProgramInfoLog(p) ?? "(无日志)";
...
GL 日志：${m}`
    ...
    const f = Zn(a, p), b = {
      ...
      linkMode: "sync",
      linkReason: yf,
      compilationInfo: Se({ label: e, backend: "webgl2", messages: o, rawLogs: l })
    };
    return this.programs.set(i, b), b;
  }
  /**
   * **异步**编译 + 链接（管线预热的入口）。
   *
  ...
  async linkAsync(e, r, n, i, s) {
    const a = this.gl, o = N(), l = this.generation, c = s.timeoutMs ?? un, h = this.parallelCompile(), p = h ? "async" : "sync", d = [], f = [], b = (y) => ({
      compiled: null,
      ok: !1,
      mode: p,
      reason: y,
      durationMs: N() - o,
      info: Se({ label: e, backend: "webgl2", messages: d, rawLogs: f })
    });
    let m = null, g = null, w = null;
    try {
      if (m = this.createShaderObject(a.VERTEX_SHADER, r, `${e} / vertex`), g = this.createShaderObject(a.FRAGMENT_SHADER, n, `${e} / fragment`), h && !await this.waitFor(
        () => a.getShaderParameter(m, h.COMPLETION_STATUS_KHR) && a.getShaderParameter(g, h.COMPLETION_STATUS_KHR),
        c
      ))
        return b(
          `shader compilation for "${e}" did not finish within ${String(c)}ms (polling COMPLETION_STATUS_KHR)`
        );
      const y = a.getShaderParameter(m, a.COMPILE_STATUS) === !0;
      lt(a.getShaderInfoLog(m), `${e} / vertex`, C.Vertex, d, f);
      const v = a.getShaderParameter(g, a.COMPILE_STATUS) === !0;
      if (lt(a.getShaderInfoLog(g), `${e} / fragment`, C.Fragment, d, f), !y || !v) {
        const L = [y ? null : "vertex", v ? null : "fragment"].filter((B) => B !== null).join(" + ");
        return b(`shader compilation failed for "${e}" (${L} stage); see info.messages`);
      }
      if (w = a.createProgram(), !w)
        return b(`gl.createProgram() returned null while prewarming "${e}"`);
      if (a.attachShader(w, m), a.attachShader(w, g), a.linkProgram(w), a.detachShader(w, m), a.detachShader(w, g), a.deleteShader(m), a.deleteShader(g), m = null, g = null, h && !await this.waitFor(
      ...
      if (lt(a.getProgramInfoLog(w), e, null, d, f), !T)
        return b(`program linking failed for "${e}"; see info.messages`);
      const E = Zn(a, w), P = {
        program: w,
        reflection: E,
        blockBindings: /* @__PURE__ */ new Map(),
        ...
        boundPlanKey: null,
        linkMode: p,
        linkReason: p === "sync" ? ui : null,
        compilationInfo: Se({ label: e, backend: "webgl2", messages: d, rawLogs: f })
      };
      return this.generation !== l ? (a.deleteProgram(w), b(`the program cache was cleared while prewarming "${e}"`)) : (w = null, this.programs.set(i, P), {
        compiled: P,
        ok: !0,
        mode: p,
        reason: p === "sync" ? ui : null,
        durationMs: N() - o,
        info: P.compilationInfo
      });
    } catch (y) {
      return b(y instanceof Error ? y.message : String(y));
    } finally {
      m && a.deleteShader(m), g && a.deleteShader(g), w && a.deleteProgram(w);
    }
  }
  ...
  compileShader(e, r, n, i, s, a) {
    ...
    if (lt(c, i, e, s, a), !o.getShaderParameter(l, o.COMPILE_STATUS))
...
${vf(n)}`
  ...
  bindResources(e, r, n, i) {
    const s = this.gl, a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map(), l = [], c = new Set(r.uniformBlocks.map((p) => p.name));
    if (n)
      for (const [p, d] of n.uniformBlocks) {
        if (!c.has(d.name)) {
          l.push(d.name);
          continue;
        }
    ...
    const h = r.uniforms.filter((p) => Fa(p.glType));
    if (n)
      for (const [, p] of n.textures) {
        const d = h.find((f) => f.name === p.name)?.location ?? s.getUniformLocation(e, p.name);
        d && (s.uniform1i(d, p.unit), o.set(p.name, d));
      }
    if (n) {
      const p = new Set([...n.uniformBlocks.values()].map((m) => m.name)), d = r.uniformBlocks.map((m) => m.name).filter((m) => !p.has(m));
      if (d.length > 0)
        throw new u(
...
WebGL2 后端靠 \`BindGroupLayoutEntry.name\` 去定位 GLSL 的 uniform block，请检查两边的名字是否一致（注意 GLSL 里块名与实例名是两回事，这里要的是**块名**）。`
      ...
      const f = new Set([...n.textures.values()].map((m) => m.name)), b = h.map((m) => m.name.replace(/\[0\]$/, "")).filter((m) => !f.has(m));
      if (b.length > 0)
        throw new u(
          `[gpu-device-api] program「${i}」使用了未声明的 sampler：${b.join("、")}。
布局里声明的纹理名：${[...f].join("、") || "(空)"}。
请为每个 sampler 增加一个 \`type: 'texture'\` 的布局条目并填上 \`name\`。`
      ...
      if (r.uniformBlocks.length > 0)
        throw new u(
          `[gpu-device-api] program「${i}」使用了 uniform block（${r.uniformBlocks.map((p) => p.name).join("、")}），但管线没有声明任何 bind group layout。`
        );
      if (h.length > 0)
        throw new u(
          `[gpu-device-api] program「${i}」使用了 sampler（${h.map((p) => `${p.name}: ${Lp(p.glType)}`).join("、")}），但管线没有声明任何 bind group layout。`
        );
    }
...
function xf(t, e) {
  ...
  let h = null;
  c && (h = {
    colorSrc: Gt(c.color.srcFactor, "color.srcFactor"),
    colorDst: Gt(c.color.dstFactor, "color.dstFactor"),
    colorOp: c.color.operation ? Ft[c.color.operation] : Ft.add,
    alphaSrc: Gt(c.alpha.srcFactor, "alpha.srcFactor"),
    alphaDst: Gt(c.alpha.dstFactor, "alpha.dstFactor"),
    alphaOp: c.alpha.operation ? Ft[c.alpha.operation] : Ft.add
  });
  const p = s ? {
    front: Bt(r?.stencilFront, "stencilFront"),
    back: Bt(r?.stencilBack, "stencilBack"),
    readMask: di(r?.stencilReadMask, "stencilReadMask", 4294967295),
    writeMask: di(r?.stencilWriteMask, "stencilWriteMask", 4294967295)
  } : {
    front: Bt(void 0, "stencilFront"),
    back: Bt(void 0, "stencilBack"),
    readMask: 4294967295,
    writeMask: 0
  }, d = l.writeMask, f = t.primitive?.cullMode ?? "none";
  return {
    depthTest: i,
...
function Tf(t, e, r, n) {
  ...
  for (let l = 0; l < e.length; l += 1) {
    const c = e[l];
    if (!c) continue;
    const h = c.blend ?? r, p = c.writeMask ?? i;
    if (o < 0) {
      o = l, s = h, a = p;
      continue;
    }
    if (p !== a)
      throw new u(
        pi(
          t,
          `writeMask differs between fragment.targets[${o}] and fragment.targets[${l}] (0x${a.toString(16)} vs 0x${p.toString(16)})`
        )
      );
    if (!$f(s, h))
      throw new u(
...
function Bt(t, e) {
  return {
    compare: Ef(t?.compare ?? xe.compare, `${e}.compare`),
    failOp: Cr(t?.failOp ?? xe.failOp, `${e}.failOp`),
    depthFailOp: Cr(t?.depthFailOp ?? xe.depthFailOp, `${e}.depthFailOp`),
    passOp: Cr(t?.passOp ?? xe.passOp, `${e}.passOp`)
  };
}
function Ef(t, e) {
  const r = Mn[t];
...
class Pf {
  ...
  acquireVertexArray(e, r, n, i = 0) {
    ...
    for (let p = 0; p < s.length; p++) {
      ...
      const b = d.stepMode === "instance" ? 1 : 0;
      for (const m of d.attributes) {
        const g = tf(m.format), w = f.offset + m.offset;
        c.enableVertexAttribArray(m.shaderLocation), g.integer ? c.vertexAttribIPointer(m.shaderLocation, g.size, g.type, d.arrayStride, w) : c.vertexAttribPointer(
          m.shaderLocation,
          g.size,
          g.type,
          g.normalized,
          d.arrayStride,
          w
        ), c.vertexAttribDivisor(m.shaderLocation, b);
      }
    }
...
function Lf(t, e, r) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    $e(s.offset, "setVertexBuffer 的 offset"), n.push(`${i}:${s.buffer.id}:${s.offset}:${s.size}:${a.arrayStride}:${a.stepMode ?? "vertex"}`);
  }
...
const ct = new Float32Array(4), rr = new Float32Array(1);
function Oa(t, e, r, n) {
  return ct[0] = t, ct[1] = e, ct[2] = r, ct[3] = n, ct;
}
...
class Ff {
  ...
  bind(e = {}) {
    ...
    if (r.bindFramebuffer(r.FRAMEBUFFER, this.drawFramebuffer), this.needsResolve = this.sampleCount > 1, this.resetScissor(), e.loadOp !== "load" || this.depthTexture !== null && e.depthLoadOp !== "load") {
      if (e.loadOp !== "load") {
        const [i, s, a, o] = Qe(e.clearColor), l = Oa(i, s, a, o);
...
function tn(t, e, r, n, i, s, a) {
  const { bytesPerRow: o, rowsPerImage: l, bytesPerPixel: c, tightRowBytes: h, where: p } = Ua(
    t,
    e,
    r,
    n,
...
function Ia(t, e, r, n, i, s, a, o, l, c, h, p = "writeTexture") {
  const d = e === t.TEXTURE_3D || e === t.TEXTURE_2D_ARRAY, f = (b, m) => Nf(
    o,
    a,
    new Uint8Array(l.buffer, l.byteOffset + b, m),
    p,
    h()
  );
  ...
  try {
    if (c.perRowUpload) {
      const b = s.width * c.bytesPerPixel;
      for (let m = 0; m < s.depthOrArrayLayers; m += 1)
        for (let g = 0; g < s.height; g += 1) {
          const w = (m * c.rowsPerImage + g) * c.bytesPerRow, y = f(w, b);
          d ? t.texSubImage3D(
            e,
            n,
            i.x,
...
class $i {
  ...
  createView(e = {}) {
    if (e.swizzle !== void 0 && e.swizzle !== gt)
      throw new u(
...
WebGL2 的 context 是从 canvas 上取的，一个 device 只能服务创建它的那个 canvas；请用 createDevice({ canvas }) 传入同一个 canvas，或为另一个 canvas 单独创建 device。`
  ...
  setPixelRatio(e) {
    ...
    this._pixelRatio = e;
    const r = ht(this.canvas);
    this._width = Math.max(1, Math.floor(r.width * e)), this._height = Math.max(1, Math.floor(r.height * e)), this.applyBackingSize();
  }
  resize() {
    const e = ht(this.canvas), r = Math.max(1, Math.floor(e.width * this._pixelRatio)), n = Math.max(1, Math.floor(e.height * this._pixelRatio));
...
class Qf {
  ...
  setVertexBuffer(e, r, n = 0, i = -1) {
    ...
    if (r === null) {
      if (!s) return;
      this.vertexBuffers[e] = null, this.bindingRevision = Ot++;
      return;
    }
    if (s && s.buffer === r && s.offset === n && s.size === i) return;
    const a = s ?? { buffer: r, offset: n, size: i };
    a.buffer = r, a.offset = n, a.size = i, this.vertexBuffers[e] = a, this.bindingRevision = Ot++;
  }
  setIndexBuffer(e, r, n = 0, i = -1) {
    ...
    s && s.buffer === e && s.format === r && s.offset === n && s.size === i || (s ? (s.buffer = e, s.format = r, s.offset = n, s.size = i) : this.indexBuffer = { buffer: e, format: r, offset: n, size: i }, this.bindingRevision = Ot++);
  }
  ...
  setBlendConstant(e) {
    this.assertOpen("setBlendConstant"), this.state.setBlendConstant(Qe(e));
  }
  ...
  beginMultisampleTargetPass(e, r) {
    ...
    for (const o of e.colorAttachments) {
      ...
      if (i === void 0) {
        i = o.clearValue, i !== void 0 && (s = Qe(i));
        continue;
      }
      const c = Qe(o.clearValue);
      if (s === null || !qf(s, c))
        throw new u(
      ...
      for (const [n, i] of this.bindGroups) {
        ...
        if (s) {
          ...
          for (const h of s) {
            ...
            const d = p.resource, f = d.buffer, b = d.offset ?? 0;
            if (h.dynamic) {
              const m = this.state.uniformBufferOffsetAlignment(), g = l[c++] ?? 0;
              if (m > 0 && g % m !== 0)
                throw new u(
                  `[gpu-device-api] 动态偏移 ${g} 不是 UNIFORM_BUFFER_OFFSET_ALIGNMENT（${m}）的倍数。uniform arena 的每段长度必须按这个对齐值取整。`
                );
              const w = b + g, y = d.size ?? f.size - w;
  ...
  clearRawAttachments(e, r, n) {
    ...
    this.state.resetScissor(n.texture.width, n.texture.height), e.colorAttachments.forEach((o, l) => {
      ...
      const [c, h, p, d] = Qe(o.clearValue);
      i.clearBufferfv(i.COLOR, l, Oa(c, h, p, d));
    });
    const a = e.depthStencilAttachment;
...
const be = `[gpu-device-api] WebGL2 后端不支持 compute pass。计算着色器需要 GLES 3.1，而 WebGL2 只提供 GLES 3.0。
可选方案：
  1) 切到 WebGPU 后端（createDevice({ backend: 'auto' }) 会优先选它）；
...
class Hf {
  ...
  copyBufferToTexture(e, r, n) {
    ...
    const { x: l, y: c, z: h } = Ut(r.origin), p = e.offset ?? 0, d = tn(
      e,
      n,
      o,
      "copyBufferToTexture",
    ...
    if (p + d.requiredBytes > a.size)
      throw new u(
        `[gpu-device-api] copyBufferToTexture: the source range [${p}, ${p + d.requiredBytes}) exceeds buffer「${a.label}」's ${a.size} bytes — ${n.width}x${n.height}x${n.depthOrArrayLayers} pixels need bytesPerRow=${d.bytesPerRow} and rowsPerImage=${d.rowsPerImage}.`
      );
    const f = new Uint8Array(d.requiredBytes);
    a.download(p, f), Ia(
      i,
      s.target,
      s.native,
  ...
  copyTextureToBuffer(e, r, n) {
    ...
    const h = n.width * a.bytesPerPixel, p = new Uint8Array(o.requiredBytes), d = this.state.currentFramebuffer(), f = a.depth ? i.DEPTH_ATTACHMENT : i.COLOR_ATTACHMENT0, b = e.mipLevel ?? 0, { x: m, y: g, z: w } = Ut(e.origin);
    i.pixelStorei(i.PACK_ALIGNMENT, 1);
    const y = new Uint8Array(h * n.height);
    for (let v = 0; v < n.depthOrArrayLayers; v += 1) {
      if (Kf(this.state, i, s, f, b, w + v), v === 0) {
        const T = i.checkFramebufferStatus(i.FRAMEBUFFER);
        if (T !== i.FRAMEBUFFER_COMPLETE)
          throw i.pixelStorei(i.PACK_ALIGNMENT, 4), this.state.bindFramebuffer(d), this.state.invalidateFramebufferBinding(), this.state.forgetReadbackTexture(), new u(
            `[gpu-device-api] 无法把纹理「${s.label}」的第 ${w} 层作为附件读回（framebuffer 不完整，0x${T.toString(16)}）。请确认该纹理的 usage 里包含 RenderAttachment 或 CopySrc。`
          );
      }
      i.readPixels(m, g, n.width, n.height, a.format, a.type, y), Wf(y, p, v * o.rowsPerImage * o.bytesPerRow, h, o.bytesPerRow, n.height);
    }
    i.pixelStorei(i.PACK_ALIGNMENT, 4), this.state.bindFramebuffer(d), this.state.forgetReadbackTexture(), this.state.invalidateFramebufferBinding(), c.upload(l, p);
  }
  /**
  ...
  copyTextureToTexture(e, r, n) {
    ...
    const { x: p, y: d, z: f } = Ut(e.origin), { x: b, y: m, z: g } = Ut(r.origin), w = Na(i, s);
    ...
    try {
      i.bindFramebuffer(i.READ_FRAMEBUFFER, E), It(i, i.READ_FRAMEBUFFER, s, v, c, f), i.bindFramebuffer(i.DRAW_FRAMEBUFFER, P), It(
        i,
        i.DRAW_FRAMEBUFFER,
        a,
        v,
   ...
   */
  clearBuffer(e, r = 0, n) {
    this.assertOpen("clearBuffer"), $e(r, `${this.label}.clearBuffer offset`);
    const i = n ?? e.size - r;
    if (r % 4 !== 0)
      throw new u(
...
class rm {
  ...
  acquire(e) {
    ...
    const c = [], h = [];
    for (let f = 0; f < i; f += 1) {
      const b = e.colorAttachments[f];
      if (!b) {
        h.push(a.NONE);
        continue;
      }
      const m = b.view, g = m.target;
      c.push(m.texture), g === a.TEXTURE_2D ? a.framebufferTexture2D(
        a.FRAMEBUFFER,
        a.COLOR_ATTACHMENT0 + f,
        g,
        m.glTexture,
        m.descriptor.baseMipLevel
      ) : a.framebufferTextureLayer(
        a.FRAMEBUFFER,
        a.COLOR_ATTACHMENT0 + f,
        m.glTexture,
        m.descriptor.baseMipLevel,
        m.descriptor.baseArrayLayer
      ), h.push(a.COLOR_ATTACHMENT0 + f);
    }
    h.length > 0 && a.drawBuffers(h);
    const p = e.depthStencilAttachment;
    if (p) {
      const f = p.view, m = F(f.texture.format).stencil ? a.DEPTH_STENCIL_ATTACHMENT : a.DEPTH_ATTACHMENT;
    ...
    const d = a.checkFramebufferStatus(a.FRAMEBUFFER);
    if (a.bindFramebuffer(a.FRAMEBUFFER, l), d !== a.FRAMEBUFFER_COMPLETE)
      throw a.deleteFramebuffer(o), new u(
        `[gpu-device-api] 这组渲染附件在 WebGL2 下不构成完整的 framebuffer（GL 状态码 0x${d.toString(16)}）。
...
class im {
  ...
  writeTexture(e, r, n, i) {
    ...
    ), p = new Uint8Array(r.buffer, r.byteOffset + c, r.byteLength - c);
    Ia(
      l,
      s.target,
      s.native,
  ...
  copyExternalImageToTexture(e, r, n, i = !1, s) {
    ...
    const p = s?.premultipliedAlpha ?? !0;
    l.pixelStorei(l.UNPACK_PREMULTIPLY_ALPHA_WEBGL, p ? 1 : 0);
    try {
...
class um {
  ...
  _disposed = !1;
  constructor(e) {
    this.gl = e.gl, this.canvas = e.canvas, this.native = e.gl, this.debug = e.descriptor?.debug ?? !1, this.logger = e.logger ?? nt("gpu-device-api/webgl2"), this.label = e.descriptor?.label ?? U("webgl2Device"), this.limits = Ms(e.adapterLimits, e.descriptor?.requiredLimits, "webgl2");
...
当前可用特性：${r.join("、") || "(无)"}。`
  ...
  createRenderPipeline(e) {
    ...
    const r = e.label ?? "renderPipeline", n = wt({
      backend: "webgl2",
    ...
    if (e.layout === void 0 || e.layout === "auto") {
      ...
      if (c.length === 0)
        ...
        a = this.track(p), this.programs.bindPlan(s, a.bindingPlan);
      }
    } else {
      const c = _s(
        e.layout,
...
function Lm(t) {
  ...
  let e = 0;
  if (t & C.Vertex && (e |= ye.VERTEX), t & C.Fragment && (e |= ye.FRAGMENT), t & C.Compute && (e |= ye.COMPUTE), e === 0)
    throw new u(
...
function _m(t) {
  ...
  let e = 0;
  return t & he.Red && (e |= Dt.RED), t & he.Green && (e |= Dt.GREEN), t & he.Blue && (e |= Dt.BLUE), t & he.Alpha && (e |= Dt.ALPHA), e;
}
function Cm(t) {
...
function Xa(t) {
  ...
  let e = 0;
  return t & x.CopySrc && (e |= ut.COPY_SRC), t & x.CopyDst && (e |= ut.COPY_DST), t & x.TextureBinding && (e |= ut.TEXTURE_BINDING), t & x.StorageBinding && (e |= ut.STORAGE_BINDING), t & x.RenderAttachment && (e |= ut.RENDER_ATTACHMENT), e;
}
function Mm(t) {
  switch (t) {
    case "read":
...
class Ja {
  ...
  mappedRange = null;
  constructor(e, r) {
    if (this.device = e, this.label = r.label ?? `buffer#${e.nextResourceId("buffer")}`, tt(r.size, "BufferDescriptor.size"), r.size % 4 !== 0)
      throw new u(
  ...
  assertRange(e, r, n, i = this.size) {
    if ($e(e, `${n} offset`), tt(r, `${n} size`), e + r > i) {
...
class In {
  ...
  get swizzle() {
    return this.descriptor.swizzle ?? gt;
  }
  get disposed() {
    return this._disposed;
  }
...
class Ee {
  ...
  acquireMipPass(e, r, n, i, s) {
    ...
    if (!s) {
      ...
      }), g = { source: c, target: h, bindGroup: m, pipeline: r.pipeline };
      return this.mipPassCache.set(a, g), g;
    }
    ...
    e.queue.writeBuffer(p, 0, new Float32Array([l, 0, 0, 0]));
    const d = r.layered(), f = e.createBindGroup({
      label: `${this.label}:mip${n}`,
...
function ag(t, e) {
  ...
  const p = {
    ...
    layered() {
      if (h) return h;
      const d = `${s}:layered`, f = t.createBindGroupLayout({
        label: d,
        entries: [
          {
            binding: 0,
      ...
      return h = { pipeline: t.createRenderPipeline({
        label: d,
        layout: t.createPipelineLayout({ label: d, bindGroupLayouts: [f] }),
...
function to(t, e) {
  if (t instanceof Ee) return t.native;
  if (Di(t)) return t;
  const r = t?.native;
...
class no {
  ...
  async getCompilationInfo(e = C.Vertex) {
    ...
    const s = await i.getCompilationInfo(), a = Se({
      label: this.label,
      backend: "webgpu",
...
class io {
  ...
  constructor(e, r) {
    ...
    if (r.type === et.Timestamp && !e.hasEnabledFeature(re))
      throw new u(
...
function so(t, e, r) {
  ...
  if (Ke.find((s) => e.hasEnabledFeature(s)) === void 0)
    throw new u(
      `[gpu-device-api] ${r}: this WebGPU implementation does not enable "${Ke[0]}" (tried: ${Ke.join(", ")}), so timestamps cannot be written inside a pass. Use CommandEncoder.writeTimestamp() around the pass instead, which only needs "timestamp-query" (that is what gfx GPU timing does).`
    );
  const i = {
    querySet: yt(t.querySet, `${r}.querySet`)
  };
...
function bg(t, e, r, n) {
  ...
  if (s.type === "texture") {
    ...
    return wg(a.view, s, r, i), { binding: t.binding, resource: pt(a.view, i) };
  }
  if (s.type === "storage-texture") {
    ...
    return { binding: t.binding, resource: pt(a.view, i) };
  }
  if ("source" in a) {
    const o = a.source;
...
function wg(t, e, r, n) {
  if (!eo(t)) return;
  const i = e.texture ?? {}, s = t.format, a = Oe(s), o = i.sampleType ?? "float";
  if (o === "depth") {
...
class vt {
  ...
  static create(e, r) {
    ...
    return new vt(n, r.bindGroupLayouts, i, !1, e);
  }
  /** `layout: 'auto'` 的替身：`native` 为字符串 `'auto'`，`isAuto` 为 true。 */
  static auto(e = "auto") {
    return new vt(e, [], "auto", !0, null);
  }
  get disposed() {
    return this._disposed;
  }
...
function po(t, e) {
  ...
  if (t instanceof vt) return t.native;
  const r = t.native;
...
class ae {
  ...
  static toGPUDepthStencilState(e, r) {
    ...
    const s = { format: J(e) };
    return ae.usesDepthStencil(r) ? (n && (s.depthWriteEnabled = r?.depthWriteEnabled ?? Wn.depthWriteEnabled, s.depthCompare = nr(r?.depthCompare ?? Wn.depthCompare)), i && (s.stencilFront = kt(r?.stencilFront), s.stencilBack = kt(r?.stencilBack), s.stencilReadMask = r?.stencilReadMask ?? 4294967295, s.stencilWriteMask = r?.stencilWriteMask ?? 4294967295), r?.depthBias !== void 0 && (s.depthBias = r.depthBias), r?.depthBiasSlopeScale !== void 0 && (s.depthBiasSlopeScale = r.depthBiasSlopeScale), r?.depthBiasClamp !== void 0 && (s.depthBiasClamp = r.depthBiasClamp), s) : (n && (s.depthWriteEnabled = !1, s.depthCompare = nr("always")), i && (s.stencilFront = kt(void 0), s.stencilBack = kt(void 0), s.stencilReadMask = 4294967295, s.stencilWriteMask = 0), s);
  }
  /** 把 core 的 `MultisampleState` 翻译为 WebGPU 的 `GPUMultisampleState`。 */
  static toGPUMultisampleState(e, r) {
    const n = Tt(e?.count ?? r, "MultisampleState.count"), i = { count: n, mask: e?.mask ?? 4294967295 }, s = e?.alphaToCoverageEnabled ?? !1;
    if (s && n === 1)
      throw new u(
  ...
  static toGPUColorTargets(e, r, n = {}) {
    let i = e.length;
    for (; i > 0 && e[i - 1] === null; ) i -= 1;
    if (r && (r.length < i || r.length > e.length))
      throw new u(
        `[gpu-device-api] RenderPipeline: fragment.targets has ${r.length} entries but the render target has ${e.length} color attachments (${i} of them carry a format).`
      );
    return e.map((s, a) => {
      ...
      if (s === null) {
        if (o)
          throw new u(
            `[gpu-device-api] RenderPipeline: fragment.targets[${a}] declares a color target at location ${a}, but the render target has no color attachment there (the render pass colorAttachments[${a}] is null). Either give that location an attachment, declare this target as null, or drop the trailing entries — a location without an attachment cannot receive output.`
          );
        return null;
      }
      if (o === null) return null;
      const l = { format: J(o?.format ?? s) }, c = o?.blend ?? n.blend;
      c && (l.blend = ae.toGPUBlendState(c));
      const h = o?.writeMask ?? n.writeMask;
      return h !== void 0 && (l.writeMask = _m(h)), l;
    });
  }
...
function kt(t) {
  return {
    ...
    failOp: Mr(t?.failOp ?? xe.failOp),
    depthFailOp: Mr(t?.depthFailOp ?? xe.depthFailOp),
    passOp: Mr(t?.passOp ?? xe.passOp)
  };
}
class xg {
  cache;
...
const Tg = "vsMain", $g = "fsMain", Ur = Object.freeze({}), Eg = [], Ag = [], Ni = 4;
class kn {
  label;
  descriptor;
  layout;
  ...
  constructor(e, r) {
    ...
    this.layout = n.layout, this.ownsLayout = n.synthesized !== null, this.vertexLayouts = r.vertex.buffers ?? null, this.logger = nt(`webgpu:${this.label}`), this.sampleCountContext = `RenderPipeline "${this.label}": sampleCount`, this.cache = new xg(64, (i, s) => {
  ...
  async prewarm(e = Ur, r = {}) {
    ...
    if (this.cache.has(s)) {
      const g = await this.getCompilationInfo();
      return {
        label: this.label,
        backend: "webgpu",
        ok: !g.hasErrors,
    ...
    try {
      typeof l == "function" ? p = await Ls(
        l.call(o, a),
        r.timeoutMs ?? un,
        `createRenderPipelineAsync("${this.label}")`
      ) : p = this.device.native.createRenderPipeline(a);
    } catch (g) {
      d = g instanceof Error ? g.message : String(g), h === null && (h = d);
    }
    p !== null && !this.cache.has(s) && this.cache.set(s, p);
    const f = await this.collectCompilationInfo(d), b = p !== null && d === null, m = {
      label: this.label,
      backend: "webgpu",
      ok: b,
      mode: c,
      // 成功且是真异步时没有需要解释的东西；退化路径与失败路径都必须给出原因。
      reason: b ? c === "sync" ? h : null : d ?? "shader compilation reported errors",
      durationMs: N() - n,
      info: f
    };
    if (!m.ok && r.throwOnError)
      throw new u(cn(f));
    return m;
  }
  /**
  ...
  resolveVariant(e) {
    const r = this.descriptor, n = e.colorFormats ?? this.defaultColorFormats(), i = Tt(
      e.sampleCount ?? r.multisample?.count ?? r.render?.multisample?.count ?? 1,
      this.sampleCountContext
    ), s = e.depthFormat !== void 0 ? e.depthFormat : r.depthStencil?.format ?? null, a = r.depthStencil ?? r.render?.depthStencil, o = e.vertexLayouts ?? this.vertexLayouts ?? Eg;
    if (r.fragment && !Lg(n))
      throw new u(
  ...
  toGPURenderPipelineDescriptor(e) {
    const r = this.descriptor, n = this.device.limits, i = r.vertex, a = {
      module: dt(i.module, `RenderPipeline "${this.label}".vertex.module`).compile(C.Vertex),
      entryPoint: i.entryPoint ?? Tg,
    ...
    o && (l = {
      ...
      entryPoint: o.entryPoint ?? $g,
      targets: ae.toGPUColorTargets(e.colorFormats, o.targets, {
        blend: r.render?.blend,
        writeMask: r.render?.writeMask
      })
    });
    const c = r.primitive ?? r.render?.primitive, h = r.depthStencil ?? r.render?.depthStencil, p = r.multisample ?? r.render?.multisample, d = e.depthFormat, f = {
      label: this.label,
      layout: po(this.layout, `RenderPipeline "${this.label}"`),
      vertex: a,
      primitive: ae.toGPUPrimitiveState(c, this.device.features),
      multisample: ae.toGPUMultisampleState(p, e.sampleCount)
    };
    return l && (f.fragment = l), d !== null ? (f.depthStencil = ae.toGPUDepthStencilState(d, h), h && !ae.usesDepthStencil(h) && this.logger.debug("depthStencil declared without a format; emitting an always-pass, no-write state")) : h && this.logger.debug("depthStencil state declared but the variant has no depth format; ignoring it"), f;
  }
}
function Pg(t, e, r) {
  ...
  toGPUComputePipelineDescriptor() {
    ...
    return {
      ...
      compute: {
        ...
        entryPoint: this.descriptor.compute.entryPoint ?? _g
      }
    };
  }
  async collectCompilationInfo(e) {
...
class mo {
  ...
  resize(e, r) {
    ...
    const n = Vt(e, "width", this.label), i = Vt(r, "height", this.label);
...
function Fg(t, e) {
  ...
  if (t.target) {
    ...
    n = h.colorAttachments, i = h.depthStencilAttachment;
  } else
  ...
  for (let h = 0; h < n.length; h += 1) {
    const p = n[h];
    if (!p) {
      a.push(null), s.push(null);
      continue;
    }
    const d = pt(p.view, `${r}.colorAttachments`), f = p.view.texture;
    s.push(p.view.descriptor.format ?? f.format), o.push(f.sampleCount);
    const b = p.loadOp ?? "clear", m = p.storeOp ?? "store";
    if (f.sampleCount > 1 && !p.resolveTarget && m !== "discard")
      throw new u(
        `[gpu-device-api] ${r}: a multisampled color attachment (sampleCount ${f.sampleCount}) needs a resolveTarget, or storeOp must be "discard".`
      );
    const g = {
      view: d,
      loadOp: Fr(b),
    ...
    p.resolveTarget && (g.resolveTarget = pt(p.resolveTarget, `${r}.resolveTarget`)), b === "clear" && (g.clearValue = Za(p.clearValue)), a.push(g);
  }
  const l = { label: r, colorAttachments: a };
  let c = null;
  if (i) {
    const h = pt(i.view, `${r}.depthStencilAttachment`), p = i.view.descriptor.format ?? i.view.texture.format;
    c = p, o.push(i.view.texture.sampleCount);
    const d = { view: h }, f = i.depthLoadOp ?? "clear", b = i.depthStoreOp ?? "store";
    if (d.depthLoadOp = Fr(f), d.depthStoreOp = Br(b), f === "clear" && (d.depthClearValue = Gg(i.depthClearValue ?? 1, r)), i.depthReadOnly !== void 0 && (d.depthReadOnly = i.depthReadOnly), gr(p)) {
      const m = i.stencilLoadOp ?? f;
      d.stencilLoadOp = Fr(m), d.stencilStoreOp = Br(i.stencilStoreOp ?? "store"), m === "clear" && (d.stencilClearValue = i.stencilClearValue ?? 0), i.stencilReadOnly !== void 0 && (d.stencilReadOnly = i.stencilReadOnly);
    } else if (i.stencilLoadOp !== void 0 || i.stencilStoreOp !== void 0)
      throw new u(
        `[gpu-device-api] ${r}: depth format "${p}" has no stencil aspect, so stencilLoadOp / stencilStoreOp must not be set.`
      );
    l.depthStencilAttachment = d;
  }
  return t.occlusionQuerySet && (l.occlusionQuerySet = yt(t.occlusionQuerySet, `${r}.occlusionQuerySet`)), t.timestampWrites && (l.timestampWrites = so(
    t.timestampWrites,
    e,
    `${r}.timestampWrites`
  )), {
...
class Og {
  ...
  setPipeline(e) {
    this.assertOpen("setPipeline"), this.native.setPipeline(Pg(e, this.contextSetPipeline, this.variantRequest));
  }
  setBindGroup(e, r, n) {
...
class Ig {
  ...
  setPipeline(e) {
    this.assertOpen("setPipeline"), this.native.setPipeline(Cg(e, this.contextSetPipeline));
  }
  setBindGroup(e, r, n) {
    if (this.assertOpen("setBindGroup"), r) {
      uo(r, n, this.device, this.contextSetBindGroup), this.native.setBindGroup(
...
class Dg {
  ...
  beginRenderPass(e) {
    ...
    const { native: r, layout: n, hasOcclusionQuerySet: i } = Fg(e, this.device), s = e.label ?? this.label, a = new Og(
      this.device,
  ...
  beginComputePass(e) {
    ...
    const r = Ug(e, this.device), n = e?.label ?? this.label, i = new Ig(
      this.device,
  ...
  clearBuffer(e, r = 0, n) {
    this.assertRecording("clearBuffer"), $e(r, `${this.label}.clearBuffer offset`);
    const i = n ?? e.size - r;
    if (r % 4 !== 0)
      throw new u(
        `[gpu-device-api] ${this.label}.clearBuffer: offset must be a multiple of 4, got ${r}.`
  ...
  resolveQuerySet(e, r, n, i, s) {
    ...
    $e(r, `${a} firstQuery`), tt(n, `${a} queryCount`), $e(s, `${a} destinationOffset`), this.native.resolveQuerySet(
      yt(e, `${a}(querySet)`),
      r,
      n,
      V(i, `${a}(destination)`),
  ...
  writeTimestamp(e, r) {
    ...
    i.call(this.native, yt(e, `${n}(querySet)`), r);
  }
...
class Vg {
  ...
  configure(e) {
    ...
    this.sampleCountValue = Tt(n, "CanvasConfig.sampleCount"), this.depthRequestedValue = e.depth ?? !0;
    const i = {
  ...
  resize(e = !1) {
    const r = ht(this.canvas), n = Math.max(1, Math.round(r.width * this.pixelRatioValue)), i = Math.max(1, Math.round(r.height * this.pixelRatioValue));
...
class Ng {
   ...
   */
  submit(e) {
    this.device.assertUsable("Queue.submit"), this.native.submit(e.map((r) => kg(r, "Queue.submit")));
  }
...
class bo {
  ...
  constructor(e, r) {
    ...
    ), this.limits = Ya(e.limits), this.defaultSampleCount = Tt(
      r.descriptor.defaultSampleCount ?? 1,
      "DeviceDescriptor.defaultSampleCount"
    ), this.logger = nt(`webgpu:${this.label}`);
    let n = () => {
    };
    this.lost = new Promise((i) => {
      n = i;
    }), this.resolveLost = n, this.queue = new Ng(this), e.onuncapturederror = (i) => {
      this.reportError(sn(i.error));
    }, this.timing = jg(e, this.enabledFeatureSet, r.adapterFeatures), e.lost.then((i) => this.handleDeviceLost(i)), this.logger.debug(
  ...
  createTexture(e) {
    return this.assertUsable("createTexture"), this.track(Ee.create(this, e));
  }
  createSampler(e = {}) {
   ...
   */
  readQuerySet(e, r = {}) {
    this.assertUsable("readQuerySet"), yt(e, `Device "${this.label}".readQuerySet(querySet)`);
    const n = r.firstQuery ?? 0;
    $e(n, "QuerySetReadOptions.firstQuery");
  ...
  createPipelineLayout(e) {
    return this.assertUsable("createPipelineLayout"), this.track(vt.create(this, e));
  }
  /* ---------------------------------------------------------------- 管线 */
  createRenderPipeline(e) {
  ...
  createCommandEncoder(e = {}) {
    return this.assertUsable("createCommandEncoder"), this.track(new Dg(this, e));
  }
  /**
  ...
  createCanvasContext(e, r) {
    ...
    let n = this.canvasContexts.get(e);
    return (!n || n.disposed) && (n = this.track(new Vg(e)), this.canvasContexts.set(e, n)), (r !== void 0 || !n.configured) && n.configure({ ...r, device: this }), n;
  }
  /* ---------------------------------------------------------------- 错误 */
  /**
   * 注册错误回调，返回取消订阅函数。
  ...
  pushErrorScope(e) {
    ...
    r.pushErrorScope(e);
    const n = new zg(e, this.scopeLabel(), () => this.popScope());
  ...
  popScope() {
    ...
    return typeof r.popErrorScope != "function" ? Promise.reject(
      ...
      const i = sn(n);
      return e.record(i), e.markFilterMatched(Wg(n, e.filter)), i;
    }));
  }
  ...
  handleDeviceLost(e) {
    ...
    this.lostInfoValue = n, this.resolveLost(n), this._disposed || this.reportError(
      new Xe(`[gpu-device-api] WebGPU device lost (${r}): ${e.message}`, { reason: r })
    );
  }
}
function sn(t) {
  ...
  return Dr(t, "GPUValidationError") ? new u(r) : Dr(t, "GPUOutOfMemoryError") ? new ar(r) : Dr(t, "GPUInternalError") ? new mt(r) : t instanceof Error ? new te(r, { code: "GPU_ERROR", cause: t }) : new te(r);
}
function Wg(t, e) {
  const r = sn(t);
  return e === "out-of-memory" ? r instanceof ar : e === "internal" ? r instanceof mt : r instanceof u;
}
class zg {
  label;
  filter;
...
function jg(t, e, r) {
  const n = e.has(re), i = Ke.some((o) => e.has(o)), s = n && Yg(t), a = n && i;
  return {
    encoderTimestamps: s,
    passTimestamps: a,
...
let kr = null;
function Vn() {
  return kr || (kr = new Rp().register(new Zg()).register(new Kg())), kr;
}
const Jg = ["webgpu", "webgl2"];
async function eb(t = {}) {
  const e = t.registry ?? Vn(), r = t.backend && t.backend !== "auto" ? [t.backend] : t.order ?? Jg, n = await e.probeAll(r, t), i = n.find((s) => s.ok);
  if (i) {
...
async function yo(t = {}) {
  const e = t.logger ?? nt("gpu-device-api"), r = t.registry ?? Vn(), n = await eb({
    ...
    if (l)
      try {
        const c = await l.createAdapter({
          ...
          requiredFeatures: tb(t.requiredFeatures, t.optionalFeatures, c.features),
        ...
        ) : o === "webgl2" && t.backend !== "webgl2" && e.info(`已回退到 WebGL2 后端：${n.reason}`), { device: h, adapter: c, backend: o, probes: n.probes, context: p };
      } catch (c) {
        const h = c.message;
...
class br {
  ...
  constructor(e, r = {}) {
    ...
    for (const o of n) {
      ...
      const l = e[o], { element: c, count: h } = nb(l), p = sr[c], d = Vr(s, p.align), f = p.size, b = h > 1 ? Vr(p.size, 16) : p.size, m = p.columnStride === void 0 || p.columnStride === p.columnSize, g = h > 1 ? b === p.size && m : m, w = h > 1 ? b * (h - 1) + p.size : p.size;
      i.push({ name: o, type: l, info: p, byteOffset: d, byteSize: f, byteStride: b, count: h, packed: g }), s = d + w, a = Math.max(a, p.align, h > 1 ? 16 : 0);
    }
...
const Nr = "/*%uniforms%*/", Zi = "/*%attributes%*/", Wr = "/*%textures%*/", cb = {
  alpha: {
    color: { srcFactor: "src-alpha", dstFactor: "one-minus-src-alpha", operation: "add" },
    alpha: { srcFactor: "one", dstFactor: "one-minus-src-alpha", operation: "add" }
  },
...
class wr {
  ...
  constructor(e) {
    ...
    this.attributes = r.map(([d, f], b) => {
      const m = typeof f == "string" ? { format: f, stepMode: "vertex" } : f;
      return { name: d, format: m.format, location: b, stepMode: m.stepMode ?? "vertex" };
    ...
    this.textures = n.map((d, f) => {
      const b = d.binding ?? f * 2;
      return {
        name: d.name,
    ...
    const i = this.uniforms ? 1 : 0, s = this.uniforms ? this.uniforms.glslDeclaration() : "", a = this.textures.map(
      (d) => `uniform ${ub(d.sampleType, d.viewDimension, d.comparison)} ${d.name};`
    ).join(`
`), o = this.attributes.map((d) => `layout(location = ${d.location}) in ${Wo(d.format)} ${d.name};`).join(`
`);
    if (this.glsl = {
      vs: zr(e.glsl.vs, [
...
${this.glsl.fs}`);
    ...
    const l = e.wgsl, c = this.uniforms ? this.uniforms.wgslDeclaration() : "", h = this.textures.map((d) => {
      ...
      return `@group(${i}) @binding(${d.binding}) var ${d.name}: ${hb(d.sampleType, d.viewDimension)};
@group(${i}) @binding(${d.samplerBinding}) var ${d.samplerName}: ${f};`;
    }).join(`
`), p = this.attributes.length > 0 ? `struct VertexInput {
${this.attributes.map((d) => `  @location(${d.location}) ${d.name}: ${zo(d.format)},`).join(`
`)}
}` : "";
    this.wgsl = zr(l, [
      { placeholder: Nr, text: c },
      { placeholder: Zi, text: p },
  ...
  vertexBufferLayouts() {
    return this.attributes.map((e) => ({
      arrayStride: Fe(e.format).byteSize,
      stepMode: e.stepMode,
...
class mb {
  ...
  acquire(e) {
    ...
    return r || (r = new fb(this.device, e, this.options), this.arenas.set(e.key, r)), r;
  }
  beginFrame() {
...
const gb = 40, bb = 24, wb = Object.freeze({
  position: "float32x3",
  normal: "float32x3",
  uv: "float32x2",
  uv1: "float32x2",
...
class yr {
  ...
  static create(e, r) {
    ...
    for (const [m, g] of s)
      g && i.set(m, { data: g });
    for (const [m, g] of Object.entries(r.attributes ?? {}))
      i.set(m, ArrayBuffer.isView(g) ? { data: g } : g);
    if (i.size === 0)
      throw new u(`[gpu-device-api] 几何体「${n}」至少要有一个顶点属性。`);
    let a = r.vertexCount ?? 0, o = null;
    for (const [m, g] of i) {
      const w = g.format ?? Ji(m, g.data), y = Math.floor(g.data.byteLength / Fe(w).byteSize);
      g.perInstance ? o = o === null ? y : Math.min(o, y) : y > a && (a = y);
    }
    if (a <= 0)
      throw new u(
    ...
    for (const [m, g] of i) {
      const w = g.format ?? Ji(m, g.data), y = Fe(w);
      if (g.data.byteLength % y.byteSize !== 0)
        throw new u(
          `[gpu-device-api] 几何体「${n}」的属性「${m}」数据长度 ${g.data.byteLength} 字节不是其格式 ${w}（${y.byteSize} 字节）的整数倍。`
        );
      const v = a * y.byteSize;
      if (!g.perInstance && g.data.byteLength < v)
        throw new u(
          `[gpu-device-api] 几何体「${n}」的属性「${m}」只有 ${g.data.byteLength} 字节，但按顶点数 ${a} 需要 ${v} 字节。所有属性必须提供同样多的顶点（只有 \`perInstance: true\` 的实例属性可以少于顶点数）。`
        );
      const T = e.createBuffer({
        label: `${n}:${m}`,
        // WebGPU 要求 buffer 大小是 4 的倍数，这里统一对齐。
        size: es(g.data.byteLength, 4),
        usage: gb
      });
      e.queue.writeBuffer(T, 0, g.data), l.set(m, {
        name: m,
        format: w,
        byteStride: y.byteSize,
        components: y.components,
        perInstance: g.perInstance ?? !1,
        buffer: T
      });
    }
    const c = yb(r, l, i, a), h = [...i.values()].some((m) => m.perInstance === !0), p = c !== null && (r.boundingSphere !== void 0 || !h);
    let d = null, f = null, b = 0;
    if (r.indices && r.indices.length > 0) {
      const m = xb(r.indices, a, n);
      f = m instanceof Uint32Array ? "uint32" : "uint16", b = m.length, d = e.createBuffer({
        label: `${n}:indices`,
        size: es(m.byteLength, 4),
        usage: bb
      }), e.queue.writeBuffer(d, 0, m);
    }
    return new yr({
      label: n,
...
function yb(t, e, r, n) {
  ...
  return !s || !a || s.format !== "float32x3" || !(a.data instanceof Float32Array) ? null : vb(a.data, n);
}
function vb(t, e) {
  let r = 1 / 0, n = 1 / 0, i = 1 / 0, s = -1 / 0, a = -1 / 0, o = -1 / 0;
  for (let d = 0; d < e; d += 1) {
    const f = d * 3, b = t[f], m = t[f + 1], g = t[f + 2];
    b < r && (r = b), m < n && (n = m), g < i && (i = g), b > s && (s = b), m > a && (a = m), g > o && (o = g);
  }
  const l = (r + s) / 2, c = (n + a) / 2, h = (i + o) / 2;
  let p = 0;
  for (let d = 0; d < e; d += 1) {
    const f = d * 3, b = t[f] - l, m = t[f + 1] - c, g = t[f + 2] - h, w = b * b + m * m + g * g;
    w > p && (p = w);
  }
  return {
    center: Gs(l, c, h),
...
const So = Object.freeze({
  ...
  Object.keys(So)
), Pb = /* @__PURE__ */ new Set(["bgra8unorm", "bgra8unorm-srgb"]);
function rs(t, e) {
  const r = So[t];
  if (!r)
    throw new u(
      `[gpu-device-api] The gfx texture layer cannot upload "${t}" from host memory. Supported formats: ${Ab.join(", ")}. Use device.createTexture() + queue.writeTexture() for any other format.`
    );
  if (e.backend === "webgl2" && Pb.has(t))
    throw new u(
...
class ve {
  ...
  static async fromImage(e, r) {
    const n = r.label ?? "texture", i = r.format ?? "rgba8unorm", s = rs(i, e), a = r.flipY ?? !0, o = r.mipmaps ?? !0, l = await Cb(r.source, r.imageOptions);
    try {
  ...
  static build(e, r) {
    ...
    let l, c;
    try {
      r.upload(o), i && Lb(o, r.label, e.backend), l = o.createView(), c = e.createSampler({
...
function ns(t, e, r, n, i, s) {
  if (!To(t)) {
    const b = t, m = new Uint8Array(b.buffer, b.byteOffset, b.byteLength), g = e ?? 0, w = r ?? 0;
    if (g <= 0 || w <= 0)
      throw new u(
    ...
    const y = g * w * s.bytesPerPixel;
    if (m.byteLength < y)
      throw new u(
        `[gpu-device-api] Texture data has ${m.byteLength} bytes, but a ${g}x${w} ${i} texture needs ${y} bytes (${s.bytesPerPixel} per pixel).`
      );
    const v = m.subarray(0, y);
    return { data: n ? qr(v, g, w, s.bytesPerPixel) : v, width: g, height: w };
  }
  if (_b(t)) {
    const b = e ?? t.width, m = r ?? t.height;
    if (b <= 0 || m <= 0)
      throw new u(
        "[gpu-device-api] The given ImageData has no size; pass width/height explicitly."
      );
    const g = new Uint8Array(t.data.buffer, t.data.byteOffset, t.data.byteLength), w = is(g, b, m, i, s);
    return { data: n ? qr(w, b, m, s.bytesPerPixel) : w, width: b, height: m };
  }
  ...
  const p = h.getImageData(0, 0, o, l), d = new Uint8Array(p.data.buffer, p.data.byteOffset, p.data.byteLength), f = is(d, o, l, i, s);
...
function My(t, e, r) {
  ...
  for (; s > 1 || a > 1; ) {
    ...
    for (let h = 0; h < l; h++) {
      ...
      for (let f = 0; f < o; f++) {
        const b = Math.min(f * 2, s - 1), m = Math.min(f * 2 + 1, s - 1), g = (p * s + b) * 4, w = (p * s + m) * 4, y = (d * s + b) * 4, v = (d * s + m) * 4, T = (h * o + f) * 4;
        for (let E = 0; E < 4; E++)
          c[T + E] = i[g + E] + i[w + E] + i[y + E] + i[v + E] >> 2;
      }
    }
...
async function Rb(t, e, r = {}) {
  const n = Mb(t), i = e.label ?? "renderPipeline";
  if (!e.fragment)
    throw new u(
...
async function Bb(t, e, r = {}, n = {}) {
  Fb(t, "prewarmWebGPURenderPipeline");
...
class ft {
  ...
  get stats() {
    return {
      ...
      available: ft.isAvailable(this.device),
      frames: this.frames,
      delay: this.delay,
...
const Ib = le(), Db = "the pipeline of this material was already built; prewarm skipped it so the compiled program is reused as-is";
class $o {
  backend;
  device;
  context;
  ...
  static async create(e) {
    const r = e.logger ?? nt("gpu-device-api/gfx"), n = {
      ...
      ...e.gpuTiming ? { optionalFeatures: [Gb] } : {}
    });
    if (!s.context)
    ...
    if (e.pixelRatio && o.setPixelRatio(e.pixelRatio), o.resize(), e.gpuTiming)
      try {
        ...
        o.gpuTimingError = zt(l), r.warn(`GPU 计时不可用：${o.gpuTimingError}`);
      }
    return o;
  }
  /* ------------------------------------------------------------------ 尺寸 ------------------- */
  ...
  /** 创建（或直接登记）一个材质。 */
  createMaterial(e) {
    const r = e instanceof wr ? e : pb(e);
    return this.materials.has(r) || this.materials.set(r, {
      ...
      values: r.uniforms ? ab(r.createUniforms()) : null,
  ...
  get supportsGpuTiming() {
    return ft.isAvailable(this.device);
  }
  /**
  ...
  disableGpuTiming() {
    ...
    if (this.gpuTimingValue = null, this.statsValue.gpuFrameTime = null, !!e)
      try {
        ...
        this.logger.warn(`释放 GPU 计时资源失败：${zt(r)}`);
      }
  }
  /**
  ...
  disableGpuTimingAfterFailure(e, r) {
    this.gpuTimingValue = null, this.gpuTimingError = zt(r), this.statsValue.gpuFrameTime = null;
    try {
      e.destroy();
    } catch (n) {
      this.logger.warn(`释放 GPU 计时资源时又失败了一次：${zt(n)}`);
    }
  ...
  async prewarm(e = {}) {
    ...
    for (const d of n) {
      const f = this.materialState(d), b = s ? f.pipelineFlipped : f.pipeline;
      if (b) {
        h += 1, o.push(await this.skippedPrewarmResult(f, b));
        continue;
      }
      const m = this.pipelineDescriptorFor(f, s), g = this.pipelineVariantFor(m, i);
      l ??= g;
      const w = this.backend === "webgl2" ? await Rb(this.device, m, a) : await Bb(this.device, m, g, a);
  ...
  async readCompilationInfo(e) {
    return typeof e.getCompilationInfo == "function" ? e.getCompilationInfo() : Se({
      label: e.label,
      backend: this.backend,
      messages: [
        Te({
  ...
  submitDraw(e, r, n, i) {
    ...
    if (this.pass.setPipeline(s), this.currentPipeline !== s && (this.currentPipeline = s, this.statsValue.pipelineSwitches += 1), r.uniforms && n.values) {
      if (this.applyCameraUniforms(n.values, r), r.uniforms.has("model") && n.values.set("model", i.model ?? Ib), this.updateNormalMatrix(n.values, r), i.uniforms)
    ...
    e.indexBuffer && e.indexFormat ? (this.pass.setIndexBuffer(e.indexBuffer, e.indexFormat, 0, e.indexBuffer.size), this.pass.drawIndexed({
      ...
      ...i.instances !== void 0 ? { instanceCount: i.instances } : {}
    }), this.statsValue.drawCalls += 1, this.statsValue.instances += i.instances ?? 1, this.statsValue.triangles += kb(e, i) * (i.instances ?? 1);
  }
  ...
  pipelineVariantFor(e, r) {
    ...
    for (const a of n.colorAttachments)
      i.push(a ? this.attachmentFormat(a.view) : null);
...
const Vb = 1e-6, cs = M(), us = M();
function Je(t, e, r, n, i) {
  if (e === void 0) return pe(t, r, n, i);
  if (e.length < 3)
...
function Ao(t) {
  if (de(cs, t.position, t.target), Ye(cs) < Vb) {
    pe(us, t.target[0], t.target[1], t.target[2] + 1), Xr(t.viewMatrix, us, t.target, t.up);
    return;
  }
...
class Ry {
  ...
  update() {
    Nb(this.fov, this.near, this.far), Ao(this), this.computeProjection();
  }
...
class Fy {
  ...
  /** 重新计算 view / **一份** projection / projectionView 三组矩阵（按当前 `depthRange`）。 */
  update() {
    Wb(this.size, this.near, this.far), Ao(this), this.computeProjection();
  }
  /** 按 `_depthRange` 选一套函数，算出唯一的那份投影矩阵，并刷新 projectionView。 */
  computeProjection() {
...
const hs = 1e-4, we = 1e-6, zb = 0.95, H = M(), ps = M(), ds = M();
function _e(t, e) {
...
class By {
  ...
  constructor(e, r, n = {}) {
    ...
    if (this.camera = e, this.element = r, this.enabled = n.enabled ?? !0, this.enableRotate = n.enableRotate ?? !0, this.enableZoom = n.enableZoom ?? !0, this.enablePan = n.enablePan ?? !0, this.enableDamping = n.enableDamping ?? !0, this.dampingFactor = je(n.dampingFactor ?? 0.08, 0, 1), this.rotateSpeed = _e(n.rotateSpeed ?? 1, "options.rotateSpeed"), this.zoomSpeed = _e(n.zoomSpeed ?? 1, "options.zoomSpeed"), this.panSpeed = _e(n.panSpeed ?? 1, "options.panSpeed"), this.minDistance = _e(n.minDistance ?? 0.1, "options.minDistance"), this.maxDistance = _e(n.maxDistance ?? 1e3, "options.maxDistance"), this.minPolarAngle = _e(n.minPolarAngle ?? 0, "options.minPolarAngle"), this.maxPolarAngle = _e(n.maxPolarAngle ?? Math.PI, "options.maxPolarAngle"), this.minDistance <= 0)
  ...
  update() {
    ...
    se(this.previousPosition, n), se(this.previousTarget, r), de(H, n, r);
    let i = Ye(H);
    i < we ? i = this.minDistance : (this.theta = Math.atan2(H[0], H[2]), this.phi = Math.acos(je(H[1] / i, -1, 1)));
    const s = Math.abs(this.deltaTheta) > we || Math.abs(this.deltaPhi) > we, a = Math.abs(this.scale - 1) > we, o = Ye(this.panOffset) > we;
    if (!s && !a && !o)
      return !1;
    const l = this.enableDamping ? this.dampingFactor : 1;
    this.theta += this.deltaTheta * l, this.phi += this.deltaPhi * l, this.phi = je(
      this.phi,
      Math.max(this.minPolarAngle, hs),
      Math.min(this.maxPolarAngle, Math.PI - hs)
    ), i = je(i * this.scale, this.minDistance, this.maxDistance), qt(r, r, this.panOffset, l);
    ...
    const h = !Qr(n, this.previousPosition, we), p = !Qr(r, this.previousTarget, we);
    return h || p;
  }
  ...
  readSpherical() {
    ...
    const e = Ye(H);
    e < we || (this.theta = Math.atan2(H[0], H[2]), this.phi = Math.acos(je(H[1] / e, -1, 1)));
  }
  ...
  panBy(e, r) {
    ...
    de(H, n.position, n.target);
    const o = 2 * (Ye(H) * Math.tan(Aa(n.fov) / 2)) * this.panSpeed / s;
    pe(ps, i[0], i[4], i[8]), pe(ds, i[1], i[5], i[9]), qt(this.panOffset, this.panOffset, ps, -e * o), qt(this.panOffset, this.panOffset, ds, r * o);
  }
  onPointerDown = (e) => {
  ...
  onWheel = (e) => {
    ...
    const r = Math.pow(zb, this.zoomSpeed);
...
function Ae(t, e, r, n, i, s, a, o, l) {
  pe(ze, i, s, a), dn(ze, ze), t.position.push(e, r, n), t.normal.push(ze[0], ze[1], ze[2]), t.uv.push(o, l);
}
...
const qb = [0.5, 0.5, 0.5, 1];
function jb(t = {}) {
  const e = Q(t.radius ?? 0.5, "options.radius"), r = it();
  for (let n = 0; n < 3; n++) {
    const i = Math.PI / 2 + n * 2 * Math.PI / 3, s = Math.cos(i) * e, a = Math.sin(i) * e;
    Ae(r, s, a, 0, 0, 0, 1, s / (2 * e) + 0.5, a / (2 * e) + 0.5);
  }
  return r.index.push(0, 1, 2), st(r);
}
function Qb(t = {}) {
  const e = Q(t.width ?? 1, "options.width"), r = Q(t.height ?? 1, "options.height"), n = Z(t.widthSegments ?? 1, 1, "options.widthSegments"), i = Z(t.heightSegments ?? 1, 1, "options.heightSegments"), s = it(), a = n + 1;
  for (let o = 0; o <= i; o++) {
    const l = o / i, c = -r / 2 + l * r;
    for (let h = 0; h <= n; h++) {
      const p = h / n, d = -e / 2 + p * e;
      Ae(s, d, c, 0, 0, 0, 1, p, l);
    }
  }
  for (let o = 0; o < i; o++)
    for (let l = 0; l < n; l++) {
...
function qe(t, e, r, n, i, s, a) {
  ...
  for (let c = 0; c < a; c++)
    for (let h = 0; h < s; h++) {
      const p = o + c * l + h, d = p + 1, f = p + l + 1, b = p + l;
      t.index.push(p, d, f, p, f, b);
    }
}
function Yb(t = {}) {
  const e = Q(t.width ?? 1, "options.width"), r = Q(t.height ?? 1, "options.height"), n = Q(t.depth ?? 1, "options.depth"), i = Z(t.widthSegments ?? 1, 1, "options.widthSegments"), s = Z(t.heightSegments ?? 1, 1, "options.heightSegments"), a = Z(t.depthSegments ?? 1, 1, "options.depthSegments"), o = e / 2, l = r / 2, c = n / 2, h = it();
  return qe(h, [o, -l, -c], [0, r, 0], [0, 0, n], [1, 0, 0], s, a), qe(h, [-o, -l, -c], [0, 0, n], [0, r, 0], [-1, 0, 0], a, s), qe(h, [-o, l, -c], [0, 0, n], [e, 0, 0], [0, 1, 0], a, i), qe(h, [-o, -l, -c], [e, 0, 0], [0, 0, n], [0, -1, 0], i, a), qe(h, [-o, -l, c], [e, 0, 0], [0, r, 0], [0, 0, 1], i, s), qe(h, [-o, -l, -c], [0, r, 0], [e, 0, 0], [0, 0, -1], s, i), st(h);
}
function Xb(t = {}) {
  const e = Q(t.radius ?? 0.5, "options.radius"), r = Z(t.widthSegments ?? 32, 3, "options.widthSegments"), n = Z(t.heightSegments ?? 16, 2, "options.heightSegments"), i = it(), s = r + 1;
  for (let a = 0; a <= n; a++) {
    const o = a / n, l = o * Math.PI, c = Math.sin(l), h = Math.cos(l);
    for (let p = 0; p <= r; p++) {
      const d = p / r, f = d * Math.PI * 2, b = c * Math.cos(f), m = h, g = c * Math.sin(f);
      Ae(i, b * e, m * e, g * e, b, m, g, d, 1 - o);
    }
  }
  for (let a = 0; a < n; a++)
    for (let o = 0; o < r; o++) {
...
function Hb(t = {}) {
  const e = Q(t.radius ?? 0.5, "options.radius"), r = Q(t.tube ?? 0.2, "options.tube"), n = Z(t.radialSegments ?? 16, 3, "options.radialSegments"), i = Z(t.tubularSegments ?? 32, 3, "options.tubularSegments"), s = it(), a = n + 1;
  for (let o = 0; o <= i; o++) {
    const l = o / i, c = l * Math.PI * 2, h = Math.cos(c), p = Math.sin(c);
    for (let d = 0; d <= n; d++) {
      const f = d / n, b = f * Math.PI * 2, m = Math.cos(b), g = Math.sin(b), w = e + r * m, y = m * h, v = g, T = m * p;
      Ae(s, w * h, r * g, w * p, y, v, T, l, f);
    }
  }
  for (let o = 0; o < i; o++)
    for (let l = 0; l < n; l++) {
...
function ms(t, e, r, n, i) {
  const s = _o(t);
  Ae(t, 0, e, 0, 0, n, 0, 0.5, 0.5);
  for (let a = 0; a <= i; a++) {
    const o = a / i * Math.PI * 2, l = Math.sin(o), c = Math.cos(o);
    Ae(t, r * l, e, r * c, 0, n, 0, 0.5 + l * 0.5, 0.5 + c * 0.5);
  }
  for (let a = 0; a < i; a++) {
    const o = s + 1 + a, l = o + 1;
...
function Co(t = {}) {
  ...
  const o = it(), l = i + 1, c = Math.hypot(n, r - e), h = n / c, p = (r - e) / c;
  for (let d = 0; d <= s; d++) {
    const f = d / s, b = n / 2 - f * n, m = e + (r - e) * f;
    for (let g = 0; g <= i; g++) {
      const w = g / i, y = w * Math.PI * 2, v = Math.sin(y), T = Math.cos(y);
      Ae(o, m * v, b, m * T, h * v, p, h * T, w, 1 - f);
    }
  }
  for (let d = 0; d < s; d++)
    for (let f = 0; f < i; f++) {
      const b = d * l + f, m = b + 1, g = b + l + 1, w = b + l;
      o.index.push(b, w, g, b, g, m);
    }
  return a && (e > 0 && ms(o, n / 2, e, 1, i), r > 0 && ms(o, -n / 2, r, -1, i)), st(o);
}
function Zb(t = {}) {
...
function Kb(t = {}) {
  const e = Q(t.size ?? 10, "options.size"), r = Z(t.divisions ?? 10, 1, "options.divisions"), n = t.plane ?? "xz", i = t.color ?? qb, [s, a, o, l] = i, c = Po(), h = e / 2, p = e / r;
  for (let d = 0; d <= r; d++) {
    const f = -h + d * p;
...
function Ro(t = {}) {
  const e = Uo(t.direction ?? [0.5, 1, 0.6]), r = xt(t.color, [1, 1, 1, 1]);
  return {
    name: "lambert",
    attributes: { position: "float32x3", normal: "float32x3", uv: "float32x2" },
    uniforms: {
...
function Fo(t = {}) {
  const e = Uo(t.direction ?? [0.5, 1, 0.6]), r = xt(t.color, [0.9, 0.9, 0.95, 1]), n = xt(t.specular, [1, 1, 1, 1]);
  return {
    name: "phong",
    attributes: { position: "float32x3", normal: "float32x3", uv: "float32x2" },
    uniforms: {
...
function Go(t = {}) {
  const e = xt(t.color, [0.5, 0.55, 0.62, 1]);
  return {
    name: "flatLine",
    topology: "line-list",
    cullMode: "none",
...
const Oy = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  SCENE_UNIFORM_FIELDS: Ue,
  defaultUniformsOf: tw,
  flatLine: Go,
  lambert: Ro,
  materials: ew,
  normalDebug: Bo,
...
export {
  ...
  k as BindingType,
  hw as BlendFactor,
  pw as BlendOperation,
  O as BufferUsage,
  Rs as CANVAS_DEPTH_FORMAT,
  he as ColorWriteMask,
  uw as CompareFunction,
  fw as CullMode,
  Jg as DEFAULT_BACKEND_ORDER,
  ...
  gt as DEFAULT_TEXTURE_SWIZZLE,
  op as DEG2RAD,
  gs as DEPTH_STENCIL_FORMATS,
  Xe as DeviceLostError,
  Hw as DisposalScope,
  uy as EPSILON,
  vw as ERROR_SCOPE_FILTERS,
  bw as FilterMode,
  mw as FrontFace,
  Sb as FrustumCuller,
  Ab as GFX_UPLOAD_FORMATS,
  my as GLSL_PREAMBLE,
  Ca as GLSL_PRECISION_PREAMBLE,
  _p as GLSL_SAMPLER_TYPES,
  Pp as GLSL_TYPE_NAMES,
  _a as GLSL_VERSION_DIRECTIVE,
  mt as GPUInternalError,
  Gb as GPU_TIMING_FEATURE,
  yr as Geometry,
  ve as GfxTexture,
  te as GpuError,
  ft as GpuTiming,
  ow as IndexFormat,
  jw as LOG_LEVEL_NAMES,
  ...
  wr as Material,
  By as OrbitControls,
  Fy as OrthographicCamera,
  ar as OutOfMemoryError,
  Ry as PerspectiveCamera,
  iw as PrimitiveTopology,
  et as QueryType,
  lp as RAD2DEG,
  rw as RENDERABLE_FORMATS,
  $o as Renderer,
  Cs as RowOrder,
  Ue as SCENE_UNIFORM_FIELDS,
  Do as SHADER_STAGE_NAMES,
  wb as STANDARD_ATTRIBUTE_FORMATS,
  xe as STENCIL_FACE_DEFAULT,
  C as ShaderStage,
  dw as StencilOperation,
  cw as StoreOp,
  Wr as TEXTURE_PLACEHOLDER,
  ue as TextureDimension,
  x as TextureUsage,
  ji as UNIFORM_FIELD_TYPES,
  Nr as UNIFORM_PLACEHOLDER,
  fb as UniformArena,
  mb as UniformArenaPool,
  br as UniformLayout,
  Xi as UniformValues,
  No as VERTEX_FORMAT_INFO,
  u as ValidationError,
  ww as VertexStepMode,
  pl as alignTo,
  Uw as alignTo4,
  xw as asByteView,
  hn as assert,
  ...
  R as assertNever,
  $e as assertNonNegativeInteger,
  Ts as assertPassTimestampWrites,
  tt as assertPositiveInteger,
  Fw as assertPowerOfTwo,
  ...
  Nw as combineFlags,
  ts as compareOpaque,
  Tb as compareTransparent,
  Jo as compilationStageName,
  wt as compileShaderStage,
  Iw as concatTypedArrays,
  Jb as createAxes,
  Yb as createBox,
  Se as createCompilationInfo,
  Te as createCompilationMessage,
  Zb as createCone,
  Co as createCylinder,
  Vn as createDefaultBackendRegistry,
  _y as createDevice,
  yo as createDeviceWithAdapter,
  Cy as createGeometry,
  Kb as createGrid,
  nt as createLogger,
  ...
  Xb as createSphere,
  Hb as createTorus,
  jb as createTriangle,
  lb as createUniforms,
  zw as currentId,
  Fs as defaultPixelRatio,
  Qo as defaultTextureUsage,
  tw as defaultUniformsOf,
  pb as defineMaterial,
  vo as defineUniforms,
  Aa as degToRad,
  Mw as describeAdapter,
  cn as describeCompilationInfo,
  zt as describeGpuTimingFailure,
  Ub as describeGpuTimingUnavailable,
  hp as describeShaderSource,
  eb as detectBackend,
  Bs as disposeAll,
  Ko as emptyCompilationInfo,
  ny as euler,
  Ay as findWgslEntryPoint,
  Go as flatLine,
  el as formatCompilationMessage,
  Ww as formatFlags,
  gy as formatShaderErrorLog,
  oy as frustum,
  vs as fullMipLevelCount,
  Yw as getGlobalLogLevel,
  xy as getShader,
  mp as glslDefines,
  ...
  cp as inverseLerp,
  Gw as isArrayBufferView,
  Ly as isBackendAvailable,
  bs as isBufferBinding,
  $w as isBufferBindingResource,
  _w as isCompilationInfo,
  ...
  Ew as isSamplerBindingResource,
  Fa as isSamplerType,
  nw as isSrgbFormat,
  yw as isTextureBinding,
  Aw as isTextureBindingResource,
  sw as isTriangleTopology,
  Bw as isTypedArray,
  Ro as lambert,
  ...
  Ey as reflectWgslBindings,
  Ap as reflectWgslEntryPoints,
  yp as registerShader,
  wy as registerShaders,
  yy as replaceShader,
  Sy as requireShader,
  qw as resetIdCounter,
  Pw as resolveBindingLayoutEntry,
  Lw as resolveBlendState,
  ...
  Cw as toNativeViewportRect,
  hl as toUint8View,
  fl as typedArrayElementSize,
  Mo as unlit,
  Ty as unregisterShader,
  ...
  Fe as vertexFormatInfo,
  zo as vertexFormatWgslType,
  Py as wgslBindingKeys,
  gp as wgslDefines,
  Ls as withTimeout,
