 ...
 * ```
 */
export { UNIFORM_PLACEHOLDER, ATTRIBUTE_PLACEHOLDER, TEXTURE_PLACEHOLDER, Material, defineMaterial, type MaterialDesc, type MaterialTextureDesc, type ResolvedMaterialTexture, type BlendPresetName, } from './Material.js';
...
export { SCENE_UNIFORM_FIELDS, defaultUniformsOf, flatLine, lambert, normalDebug, phong, unlit, vertexColorLine, type FlatLineOptions, type LambertOptions, type LightOptions, type PhongOptions, type RgbColor, type UnlitOptions, } from './materials.js';
export { createAxes, createBox, createCone, createCylinder, createGrid, createPlane, createSphere, createTorus, createTriangle, type LineData, type ShapeData, } from './shapes.js';
