...
export declare const CANVAS_DEPTH_FORMAT: TextureFormat;
...
export declare function measureCanvas(canvas: HTMLCanvasElement | OffscreenCanvas): {
    width: number;
    height: number;
};
/** `devicePixelRatio`，会被限制在合理范围内；在浏览器之外返回 1。 */
export declare function defaultPixelRatio(): number;
