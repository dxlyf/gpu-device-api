...
export class WebGL2PipelineLayout {
     ...
     */
    constructor(descriptor, isAuto, planSource, onDispose = () => { }) {
        ...
        if (this.bindGroupLayouts.length > 4) {
            throw new ValidationError(`[gpu-device-api] pipeline layout 声明了 ${this.bindGroupLayouts.length} 个 bind group，` +
...
//# sourceMappingURL=WebGL2PipelineLayout.js.map