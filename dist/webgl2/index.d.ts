...
export { WebGL2CanvasContext, isDefaultFramebufferView, type DefaultFramebufferView, type WebGL2CanvasContextOptions, } from './WebGL2CanvasContext.js';
...
export { ANY_SAMPLES_PASSED, TIMER_QUERY_EXTENSION, WebGL2QuerySet, asWebGL2QuerySet, getTimerQueryExtension, type WebGL2TimerQueryExtension, } from './resources/WebGL2QuerySet.js';
...
export { BindingPlanCache, bindingSlotKey, buildBindingPlan, type BindingPlanLimits, type TextureSlot, type UniformBlockSlot, type WebGLBindingPlan, } from './binding/TextureUnitAllocator.js';
...
export { WebGL2RenderPipeline, type ResolvedVariant, type VertexBufferBinding, type WebGL2RenderPipelineOptions, } from './pipeline/WebGL2RenderPipeline.js';
export { WebGL2ComputePipeline } from './pipeline/WebGL2ComputePipeline.js';
export { applyRenderState, resolveRenderState, type ResolvedBlendState, type ResolvedRenderState, } from './pipeline/WebGL2RenderState.js';
...
export { DEFAULT_QUERY_POLL_TIMEOUT_MS, WebGL2QueryResult, isTimestampQueryResult, type WebGL2QueryResultInit, } from './sync/WebGL2QueryResult.js';
export { GL_ADDRESS_MODES, GL_BLEND_FACTORS, GL_BLEND_OPERATIONS, GL_COMPARE_FUNCS, GL_CULL_FACES, GL_FILTERS, GL_FRONT_FACES, GL_INDEX_TYPES, GL_PRIMITIVE_MODES, GL_STENCIL_OPS, assertColorAttachmentFormat, assertNoStorageBinding, glCompareFunc, glVertexAttribute, resolveClearColor, type GlVertexAttributeInfo, } from './utils/glEnumMap.js';
export { GL_TEXTURE_FORMATS, assertUploadDataType, glFormat, glFormatIsAttachment, sampleTypeMatchesFormat, type GlTextureFormatInfo, type TextureSampleType as GlTextureSampleType, } from './utils/glFormatMap.js';
export { WEBGL2_SYNTHETIC_LIMITS, buildDeviceLimits, queryGlFeatures, queryGlLimits, queryGlRendererInfo, queryMaxAnisotropy, requireWebGL2Context, type GlLimits, } from './utils/glCapabilities.js';
