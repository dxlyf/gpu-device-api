...
export function toUint8View(view) {
...
export function alignTo4(value) {
    return (value + 3) & ~3;
}
/**
 ...
 */
export function paddedCopy(source, alignment = 4) {
...
export function typedArrayElementSize(view) {
    return view.BYTES_PER_ELEMENT ?? 1;
}
/** 将同类型的多个 typed array 拼接为单个同类型数组。 */
export function concatTypedArrays(arrays) {
    if (arrays.length === 0)
        throw new RangeError('[gpu-device-api] concatTypedArrays() received no arrays.');
