...
export { WebGPUDevice, toGpuError } from './WebGPUDevice.js';
export { WebGPUCanvasContext, isWebGPUCanvasContext, } from './WebGPUCanvasContext.js';
/* ------------------------------------------------------------------ 资源 ----------------- */
export { WebGPUBuffer, asGPUBuffer, describeUnknown, isNativeGPUBuffer, isWebGPUBuffer, } from './resources/WebGPUBuffer.js';
export { WebGPUTexture, asGPUTexture, isNativeGPUTexture, isWebGPUTexture, } from './resources/WebGPUTexture.js';
export { WebGPUTextureView, asGPUTextureView, isNativeGPUTextureView, isWebGPUTextureView, } from './resources/WebGPUTextureView.js';
...
PipelineCache as WebGPUPipelineCache, computePipelineCacheKey, createWgpuPipelineCache, describeVertexLayouts, renderPipelineCacheKey, } from './pipeline/PipelineCache.js';
/* ------------------------------------------------------------------ 渲染 ----------------- */
...
export { WebGPURenderPassEncoder, resolveIndirect, toGPURenderPassDescriptor, } from './render/WebGPURenderPassEncoder.js';
...
export { WebGPUQueryResult } from './sync/WebGPUQueryResult.js';
/* ------------------------------------------------------------------ 工具 ----------------- */
