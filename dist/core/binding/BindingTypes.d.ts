...
export type BindingResource = BufferBinding | SamplerBinding | TextureBinding | StorageTextureBinding | ExternalTextureBinding;
export interface BindGroupEntry {
    binding: number;
    resource: BindingResource;
}
export declare function isBufferBindingResource(resource: BindingResource): resource is BufferBinding;
export declare function isSamplerBindingResource(resource: BindingResource): resource is SamplerBinding;
export declare function isTextureBindingResource(resource: BindingResource): resource is TextureBinding | StorageTextureBinding;
/** bind group layout entry 的默认值，与 WebGPU 一致。 */
export declare function resolveBindingLayoutEntry(entry: BindGroupLayoutEntry): Required<Pick<BindGroupLayoutEntry, 'binding' | 'visibility' | 'type'>> & BindGroupLayoutEntry;
/** 标记 layout 对象的释放契约。 */
export type BindingDisposable = Disposable;
//# sourceMappingURL=BindingTypes.d.ts.map