 ...
 * ```
 */
export declare function toNativeScissorRect(rect: NativeRect, attachmentHeight: number, imageOrigin: ScissorImageOrigin): NativeRect;
/**
 ...
 */
export declare function toNativeViewportRect(rect: NativeRect, attachmentHeight: number, imageOrigin: ScissorImageOrigin): NativeRect;
//# sourceMappingURL=ScissorOrigin.d.ts.map