 ...
 */
export declare const RowOrder: {
    readonly TopLeft: "topLeft";
    readonly BottomUp: "bottomUp";
};
export type RowOrder = (typeof RowOrder)[keyof typeof RowOrder];
/** 清除颜色。接受 CSS 字符串、`0xRRGGBB`、0..1 范围的 `[r,g,b,a]` 以及 `{ r, g, b, a }`。 */
export type Color = string | number | readonly [number, number, number] | readonly [number, number, number, number] | {
    r: number;
    g: number;
    b: number;
    a?: number;
