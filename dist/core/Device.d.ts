...
import type { ExternalTexture, ExternalTextureDescriptor } from './resources/ExternalTexture.js';
 ...
 */
export declare function resolveLimits(adapterLimits: DeviceLimits, required: Partial<DeviceLimits> | undefined, backend: BackendKind): DeviceLimits;
